export interface components {
    schemas: {
        ...
        OrgDeptTreeDeptStaffVO: {
            ...
            id?: string;
            childrenDept?: components["schemas"]["OrgDeptTreeDeptStaffVO"][];
            /** Format: int64 */
            autoNo?: number;
            /** @description 部门名称 */
            name?: string;
        ...
        OrgDeptsLess: {
            /** @description 唯一标识  dept+autoNo */
            unionKey?: string;
            childrenDept?: components["schemas"]["OrgDeptsLess"][];
            /**
             * Format: int64
             * @description 部门的 主键
             */
        ...
        DynamicMatchFieldMetaData: {
            ...
            options?: string[];
            required?: boolean;
            matchedColumn?: components["schemas"]["ExcelColumnInfo"];
            score?: number;
            autoMatch?: boolean;
            displayValueConverter?: components["schemas"]["DisplayValueConverter?"];
            emptyValueSetHandler?: components["schemas"]["EmptyValueSetHandler?"];
        };
        FieldConfigVO: {
            /** @description 分组名称 */
            groupName?: string;
        ...
        FieldConfig: {
            ...
            fieldType?: number;
            /** @description 字段配置表 */
            itemConfigs?: components["schemas"]["FieldItemConfig"][];
            /** @description 字段可选项 */
            options?: string[];
            /** @description 字段命名空间 */
            namespace?: string;
        ...
        AppraiseConfig: {
            ...
            /** @description ORK配置 */
            okrConfig?: string;
            orkConfigList?: components["schemas"]["RatingConfig"][];
            /** @description 最后更新时间 */
            updatedAt?: string;
            cycleConfigList?: components["schemas"]["CycleConfig"][];
            ratingConfigList?: components["schemas"]["RatingConfig"][];
            scoreConfigList?: components["schemas"]["AppraiseConfigScoreMapping"][];
            kpiConfigList?: components["schemas"]["AppraiseConfigScoreMapping"][];
        };
        FieldDetail: {
            /** @description 字段名 */
            fieldName?: string;
        ...
        PositionVO: {
            ...
            positionId?: number;
            /** @description 职位关联职级 */
            postLevels?: components["schemas"]["SysPostLevelBindData"][];
            /**
             * Format: int64
             * @description 序列ID
             */
        ...
        TaskClassifyVO: {
            ...
            createTime?: string;
            /** @description 子集 */
            children?: components["schemas"]["TaskClassifyVO"][];
        };
        SmsCodeVO: {
            code?: string;
        };
        ...
        UserGroupTreeVO: {
            ...
            num?: number;
            /** @description 子集 */
            children?: components["schemas"]["UserGroupTreeVO"][];
        };
        DataPermissionVO: {
            /** @description 主键ID */
            id?: string;
        ...
        DocumentInfoES: {
            ...
            modifyTime?: string;
            catName?: string;
            staffNameIdPicVO?: components["schemas"]["StaffNameIdPicVO"];
        };
        ClockWayVO: {
            /**
             * Format: int64
        ...
        CompanyTargetValue: {
            ...
            rule?: number;
            children?: components["schemas"]["CompanyTargetValue"][];
            /** @description 拆解目标合计 */
            disassembledTotal?: number;
            staff?: components["schemas"]["StaffNameIdPicVO"];
            diff?: number;
            old?: components["schemas"]["CompanyTargetValue"];
            logList?: components["schemas"]["HrOperLog"][];
        };
        TeamEmployeeVO: {
            /** @description 员工ID */
            staffNo?: string;
        ...
        ServiceResultListOrgDeptTreeDeptStaffVO: {
            code?: string;
            success?: boolean;
            data?: components["schemas"]["OrgDeptTreeDeptStaffVO"][];
            message?: string;
            tid?: string;
        };
        ServiceResultListHrmStaffBaseInfo: {
            code?: string;
            success?: boolean;
            data?: components["schemas"]["HrmStaffBaseInfo"][];
            message?: string;
            tid?: string;
        };
        BngRoleDelDTO: {
        ...
        ServiceResultListOrgDeptsLess: {
            code?: string;
            success?: boolean;
            data?: components["schemas"]["OrgDeptsLess"][];
            message?: string;
            tid?: string;
        };
        ...
        ServiceResultListFieldConfigVO: {
            code?: string;
            success?: boolean;
            data?: components["schemas"]["FieldConfigVO"][];
            message?: string;
            tid?: string;
        };
        ...
        ServiceResultExcelTaskInfo: {
            code?: string;
            success?: boolean;
            data?: components["schemas"]["ExcelTaskInfo"];
            message?: string;
            tid?: string;
        };
        ServiceResultListAppMenuGroupVo: {
            code?: string;
            success?: boolean;
            data?: components["schemas"]["AppMenuGroupVo"][];
            message?: string;
            tid?: string;
        };
        StaffOnOffDTO: {
        ...
        StaffFieldConfigVO: {
            ...
            fieldType?: number;
            /** @description 字段配置表 */
            configItems?: components["schemas"]["CustomFieldConfig"][];
            /** @description 字段命名空间（system：系统内置字段；custom：自定义字段） */
            namespace?: string;
        };
        CompanyOnOffDTO: {
        ...
        ServiceResultListHrOperLog: {
            code?: string;
            success?: boolean;
            data?: components["schemas"]["HrOperLog"][];
            message?: string;
            tid?: string;
        };
        AppraiseConfigForcedRule: {
            ...
            staffNums?: number;
            /** @description 覆盖人员列表 */
            staffList?: components["schemas"]["StaffNameIdPicVO"][];
            refIdDetail?: components["schemas"]["RefIdDetail"];
            /** @description 负责人 */
            leader?: components["schemas"]["StaffNameIdPicVO"];
            /** @description 是否覆盖 0 不覆盖 1 覆盖 */
            skiped?: number;
            versionId?: number;
            totalCount?: number;
            /** @description 分布比例详情实体（映射distribution的JSON结构） */
            distributionDetailItemList?: components["schemas"]["DistributionDetailItem"][];
        };
        StaffFieldVO: {
            /** @description 分组名称 */
            groupName?: string;
        ...
        StaffRosterDataVO: {
            /** Format: int64 */
            staffNo?: number;
            fields?: components["schemas"]["MapString"];
        };
        AppraisePostVO: {
            /** @description 树状唯一标识 */
            unionKey?: string;
            ...
            deptName?: string;
            /** @description 考核表 */
            appraiseTableVOList?: components["schemas"]["AppraiseTableVO1"][];
            /** @description 职位名称 */
            name?: string;
            /** @description 人数 */
            staffCount?: number;
        ...
        AppriasePostTableItemVO: {
            ...
            ratingConfig?: components["schemas"]["RatingConfig"];
            /** @description ruleType = 2:区间映射评分配置 */
            percentageRangeConfig?: components["schemas"]["PercentageRangeConfig"];
            /** @description ruleType = 3: 目标增减分配置 */
            targetBasedConfig?: components["schemas"]["TargetBasedConfig"];
            /** @description ruleType = 4:完成率对应系数配置 */
            completionCoefficientConfig?: components["schemas"]["CompletionCoefficientConfig"];
            /** @description ruleType = 5,6:加减分项 */
            addDeductConfig?: components["schemas"]["AddDeductConfig"];
            /** @description 目标值 */
            targetValue?: number;
            /** @description 员工确认值 */
            selfValue?: number;
            ...
            completeUser?: string;
            /** @description 完成值数据来源 */
            completeUserList?: components["schemas"]["StaffNameIdPicVO"][];
        };
        AppraiseYearStaffTargetVO: {
            ...
            /** @description 员工头像 */
            personalPhoto?: string;
            children?: components["schemas"]["AppraiseYearStaffTargetVO"][];
            /** @description 1-12月 */
            monthTargetList?: components["schemas"]["AppraiseStaffValue"][];
        };
        ServiceResultListPositionVO: {
            ...
            success?: boolean;
            /** @description 主数据 */
            data?: components["schemas"]["PositionVO"][];
            /** @description 业务状态消息 */
            message?: string;
            /** @description trace id */
            tid?: string;
        ...
        ServiceResultStaffDashboardReportVO: {
            ...
            success?: boolean;
            /** @description 主数据 */
            data?: components["schemas"]["StaffDashboardReportVO"];
            /** @description 业务状态消息 */
            message?: string;
            /** @description trace id */
            tid?: string;
        ...
        ServiceResultListDocNoticeType: {
            ...
            success?: boolean;
            /** @description 主数据 */
            data?: components["schemas"]["DocNoticeType"][];
            /** @description 业务状态消息 */
            message?: string;
            /** @description trace id */
            tid?: string;
        ...
        StaffSelectionMeta: {
            ...
            operators?: number[];
            /** @description 条件可选项 */
            options?: components["schemas"]["StaffDimensionData"][];
        };
        ...
        ServiceResultListAppraiseProjectStaffVO: {
            code?: string;
            success?: boolean;
            data?: components["schemas"]["AppraiseProjectStaffVO"][];
            message?: string;
            tid?: string;
        };
        ...
        ServiceResultListTaskClassifyVO: {
            code?: string;
            success?: boolean;
            data?: components["schemas"]["TaskClassifyVO"][];
            message?: string;
            tid?: string;
        };
        ServiceResultSmsCodeVO: {
            code?: string;
            success?: boolean;
            data?: components["schemas"]["SmsCodeVO"];
            message?: string;
            tid?: string;
        };
        HrLoginVO: {
            ...
            /** @description 关联企业列表 */
            companyList?: components["schemas"]["CompanySummaryVO"][];
            /** @description 当前登录企业 */
            currentCompany?: components["schemas"]["CompanySummaryVO"];
        };
        ServiceResultListUserGroupTreeVO: {
            code?: string;
            success?: boolean;
            data?: components["schemas"]["UserGroupTreeVO"][];
            message?: string;
            tid?: string;
        };
        ServiceResultListDataPermissionVO: {
            code?: string;
            success?: boolean;
            data?: components["schemas"]["DataPermissionVO"][];
            message?: string;
            tid?: string;
        };
        LoginNameCheckRO: {
        ...
        ServiceResultListCompanySummaryVO: {
            code?: string;
            success?: boolean;
            data?: components["schemas"]["CompanySummaryVO"][];
            message?: string;
            tid?: string;
        };
        AppraiseCycleTableVO: {
            ...
            /** @description kpi权重 */
            kpiWeight?: number;
            cycleList?: components["schemas"]["AppraiseStaffProjectCycle"][];
            /** @description 1 考评中 2 已完成 */
            status?: number;
            groupMap?: components["schemas"]["MapListGroupVO"];
        };
        ServiceResultListHrCompanySummaryVO: {
            ...
            success?: boolean;
            /** @description 主数据 */
            data?: components["schemas"]["HrCompanySummaryVO"][];
            /** @description 业务状态消息 */
            message?: string;
            /** @description trace id */
            tid?: string;
        ...
        ServiceResultListTitleNode: {
            code?: string;
            success?: boolean;
            data?: components["schemas"]["TitleNode"][];
            message?: string;
            tid?: string;
        };
        RichTextParseVO: {
            /** @description 解析后的层级标题目录（含锚点ID） */
            titleNodes?: components["schemas"]["TitleNode"][];
        ...
        ServiceResultMapInteger: {
            code?: string;
            success?: boolean;
            data?: components["schemas"]["MapInteger"];
            message?: string;
            tid?: string;
        };
        ServiceResultListUserGroupVO: {
            ...
            success?: boolean;
            /** @description 主数据 */
            data?: components["schemas"]["UserGroupVO"][];
            /** @description 业务状态消息 */
            message?: string;
            /** @description trace id */
            tid?: string;
        ...
        ServiceResultCompanyTargetValue: {
            code?: string;
            success?: boolean;
            data?: components["schemas"]["CompanyTargetValue"];
            message?: string;
            tid?: string;
        };
        AvatarModifyRO: {
        ...
        BaseQueryDTO: {
             ...
             *     ---------------------------------------------------
             */
            forceIndexMap?: components["schemas"]["MapString"];
            updateUser?: string;
            extraType?: number;
            /**
             * Format: int64
            ...
            extraMap?: components["schemas"]["MapString"];
        };
        StaffShiftScheduleInfo: {
            ...
            isDayOff?: boolean;
            /** @description 班次信息 */
            shiftInfo?: components["schemas"]["ShiftBaseInfoVO"];
            /** @description 员工信息 */
            staffBaseInfo?: components["schemas"]["StaffBaseInfo"];
        };
        TimePeriod: {
        ...
        PageOrgDept: {
            records?: components["schemas"]["OrgDept"][];
            /** Format: int64 */
            total?: number;
            /** Format: int64 */
            size?: number;
        ...
        UserRoleDTO: {
            ...
            roleId?: number;
            /** @description 可以为空 */
            roleUsers?: components["schemas"]["AddRoleUserDTO"][];
        };
        PageSysPost: {
        ...
        ServiceResultCompanySyncRecord: {
            code?: string;
            success?: boolean;
            data?: components["schemas"]["CompanySyncRecord"];
            message?: string;
            tid?: string;
        };
        PageCompanyThirdPartyConfig: {
            records?: components["schemas"]["CompanyThirdPartyConfig"][];
            /** Format: int64 */
            total?: number;
            /** Format: int64 */
            size?: number;
        ...
        PageSysLoginDevice: {
            records?: components["schemas"]["SysLoginDevice"][];
            /** Format: int64 */
            total?: number;
            /** Format: int64 */
            size?: number;
        ...
        StaffAppVo: {
            ...
            isDefault?: number;
            menuList?: components["schemas"]["BngMenuVO"][];
            groupList?: string[];
        ...
        PageContactVO: {
            ...
            records: components["schemas"]["ContactVO"][];
            /**
             * Format: int64
             * @default 0
             */
        ...
        ServiceResultListStaffFieldConfigVO: {
            code?: string;
            success?: boolean;
            data?: components["schemas"]["StaffFieldConfigVO"][];
            message?: string;
            tid?: string;
        };
        ExportField: {
        ...
        PageAppraiseItem: {
            records?: components["schemas"]["AppraiseItem"][];
            /** Format: int64 */
            total?: number;
            /** Format: int64 */
            size?: number;
        ...
        ServiceResultListStaffFieldVO: {
            code?: string;
            success?: boolean;
            data?: components["schemas"]["StaffFieldVO"][];
            message?: string;
            tid?: string;
        };
        ...
        AppraiseDeptVO: {
            ...
            type: number;
            /** @description 子部门 */
            childrenDept?: components["schemas"]["AppraiseDeptVO"][];
            /** @description 当前部门职位 */
            postList?: components["schemas"]["AppraisePostVO"][];
        };
        GroupFieldsCreate: {
            /** @description 字段分组唯一标识 */
            groupIdentity: string;
            /** @description 字段列表 */
            fields?: components["schemas"]["FieldValueCreate"][][];
        };
        AppriasePostTableGroupVO: {
            ...
            /** @description 字典类型名称 */
            dictTypeName?: string;
            itemList?: components["schemas"]["AppriasePostTableItemVO"][];
            /** @description 权重 */
            weight?: number;
            /** @description 自评本项得分 */
        ...
        PageDocFile: {
            records?: components["schemas"]["DocFile"][];
            /** Format: int64 */
            total?: number;
            /** Format: int64 */
            size?: number;
        ...
        ServiceResultListAppraiseYearStaffTargetVO: {
            code?: string;
            success?: boolean;
            data?: components["schemas"]["AppraiseYearStaffTargetVO"][];
            message?: string;
            tid?: string;
        };
        ...
        ServiceResultListStaffSelectionMeta: {
            code?: string;
            success?: boolean;
            data?: components["schemas"]["StaffSelectionMeta"][];
            message?: string;
            tid?: string;
        };
        StaffSelectionMetaVO: {
            /** @description 快速条件项 */
            quickCondition?: components["schemas"]["StaffSelectionMetaItem"][];
            /** @description 条件项 */
            conditions?: components["schemas"]["StaffSelectionMetaItem"][];
        };
        PageWorkPlanVO: {
            /**
             * @description 查询数据列表
             * @default Collections.emptyList()
             */
            records: components["schemas"]["WorkPlanVO"][];
            /**
             * Format: int64
             * @description 总数
             * @default 0
        ...
        DailyMonthlyReportRecordsVO: {
            ...
            address?: string;
            /** @description 附件 */
            attachments?: components["schemas"]["DailyMonthlyReportRecordsAttachmentVO"][];
            /** @description 创建时间 */
            createTime?: string;
        };
        ServiceResultDocFilePresignedVO: {
            ...
            success?: boolean;
            /** @description 主数据 */
            data?: components["schemas"]["DocFilePresignedVO"];
            /** @description 业务状态消息 */
            message?: string;
            /** @description trace id */
            tid?: string;
        ...
        ServiceResultHrLoginVO: {
            code?: string;
            success?: boolean;
            data?: components["schemas"]["HrLoginVO"];
            message?: string;
            tid?: string;
        };
        BngMenuVO: {
        ...
        ServiceResultListAppraiseCycleTableVO: {
            code?: string;
            success?: boolean;
            data?: components["schemas"]["AppraiseCycleTableVO"][];
            message?: string;
            tid?: string;
        };
        GroupVO: {
        ...
        ServiceResultRichTextParseVO: {
            code?: string;
            success?: boolean;
            data?: components["schemas"]["RichTextParseVO"];
            message?: string;
            tid?: string;
        };
        DocumentInfo: {
            ...
            titleNodes?: components["schemas"]["TitleNode"][];
            /** @description 原文档 */
            origin?: components["schemas"]["DocumentInfo"];
            catName?: string;
            /**
             * Format: int64
             * @description 上一个
        ...
        IPageDocumentInfoES: {
            records?: components["schemas"]["DocumentInfoES"][];
            /** Format: int64 */
            total?: number;
            /** Format: int64 */
            size?: number;
        ...
        PageClockWayVO: {
            records?: components["schemas"]["ClockWayVO"][];
            /** Format: int64 */
            total?: number;
            /** Format: int64 */
            size?: number;
        ...
        PageProjectListVO: {
             ...
             * @default Collections.emptyList()
             */
            records: components["schemas"]["ProjectListVO"][];
            /**
             * Format: int64
             * @description 总数
             * @default 0
        ...
        PageTeamEmployeeVO: {
            records?: components["schemas"]["TeamEmployeeVO"][];
            /** Format: int64 */
            total?: number;
            /** Format: int64 */
            size?: number;
        ...
        ShiftAccountGeneralSituation: {
            ...
            changeShiftInfo?: components["schemas"]["StaffShiftScheduleInfo"];
        ...
        ServiceResultPageOrgDept: {
            code?: string;
            success?: boolean;
            data?: components["schemas"]["PageOrgDept"];
            message?: string;
            tid?: string;
        };
        StaffCustomMenuSort: {
            ...
            /** @description 备注 */
            remark?: string;
            menuDTOList?: components["schemas"]["MenuDTO"][];
        };
        PowerDTO: {
            /** Format: int64 */
            powerId?: number;
        ...
        ServiceResultPageCompanyThirdPartyConfig: {
            code?: string;
            success?: boolean;
            data?: components["schemas"]["PageCompanyThirdPartyConfig"];
            message?: string;
            tid?: string;
        };
        "Page?": {
        ...
        ServiceResultPageSysLoginDevice: {
            code?: string;
            success?: boolean;
            data?: components["schemas"]["PageSysLoginDevice"];
            message?: string;
            tid?: string;
        };
        FieldMatchResponse: {
            ...
            url?: string;
            identityCode?: string;
            dataFields?: components["schemas"]["FieldMatchResult"][];
            columns?: components["schemas"]["ExcelColumnInfo"][];
            excelRows?: components["schemas"]["MapObject"][];
        };
        QueryTaskRequest: {
            taskId: string;
            type?: string;
        ...
        ExcelHandleRequestStaffImportParam: {
            type: string;
            taskParam?: components["schemas"]["StaffImportParam"];
            excelFileUrl: string;
            fileName: string;
        };
        "DisplayValueConverter?": Record<string, never>;
        ServiceResultListStaffAppVo: {
            code?: string;
            success?: boolean;
            data?: components["schemas"]["StaffAppVo"][];
            message?: string;
            tid?: string;
        };
        ServiceResultPageContactVO: {
            code?: string;
            success?: boolean;
            data?: components["schemas"]["PageContactVO"];
            message?: string;
            tid?: string;
        };
        MapInteger: {
        ...
        ServiceResultPageAppraiseItem: {
            code?: string;
            success?: boolean;
            data?: components["schemas"]["PageAppraiseItem"];
            message?: string;
            tid?: string;
        };
        AppraiseConfigVO: {
            cycleConfigList?: components["schemas"]["CycleConfig"][];
            showStyleDTO?: components["schemas"]["ShowStyleDTO"];
            /** @description List<AppraiseConfigForcedRule> forcedRuleList;//绩效强制分布 */
            scoreMappingList?: components["schemas"]["AppraiseConfigScoreMapping"][];
            /** @description 定性考评 */
            ratingConfigList?: components["schemas"]["RatingConfig"][];
            /** @description 1 显示等级 2 显示描述 3 显示等级+描述 */
            showType?: number;
        ...
        ServiceResultListStaffFieldBusinessPointConfigVO: {
            ...
            success?: boolean;
            /** @description 主数据 */
            data?: components["schemas"]["StaffFieldBusinessPointConfigVO"][];
            /** @description 业务状态消息 */
            message?: string;
            /** @description trace id */
            tid?: string;
        ...
        PageStaffRosterDataVO: {
            records?: components["schemas"]["StaffRosterDataVO"][];
            /** Format: int64 */
            total?: number;
            /** Format: int64 */
            size?: number;
        ...
        ServiceResultListAppraiseDeptVO: {
            code?: string;
            success?: boolean;
            data?: components["schemas"]["AppraiseDeptVO"][];
            message?: string;
            tid?: string;
        };
        AdminStaffCreateROCreate: {
            ...
            id?: number;
            /** @description 字段分组列表 */
            groups: components["schemas"]["GroupFieldsCreate"][];
        };
        AppraisePostTableConfig: {
            ...
            crossIds?: string;
            /** @description 360下属评价 */
            subList?: components["schemas"]["StaffNameIdPicVO"][];
            /** @description 360横向评价 */
            crossList?: components["schemas"]["StaffNameIdPicVO"][];
            /** @description 考核人名字 */
            leaderList?: components["schemas"]["StaffNameIdPicVO"][];
        };
        ServiceResultPageDocFile: {
            ...
            success?: boolean;
            /** @description 主数据 */
            data?: components["schemas"]["PageDocFile"];
            /** @description 业务状态消息 */
            message?: string;
            /** @description trace id */
            tid?: string;
        ...
        SelectionCondition: {
            ...
            operator?: 1 | 2 | 3 | 4 | 5;
            /** @description 维度数据 */
            data?: components["schemas"]["StaffDimensionData"][];
        };
        ServiceResultStaffSelectionMetaVO: {
            code?: string;
            success?: boolean;
            data?: components["schemas"]["StaffSelectionMetaVO"];
            message?: string;
            tid?: string;
        };
        ServiceResultPageWorkPlanVO: {
            code?: string;
            success?: boolean;
            data?: components["schemas"]["PageWorkPlanVO"];
            message?: string;
            tid?: string;
        };
        DailyMonthlyReportVO: {
            ...
            userId?: string;
            /** @description 日月报记录 */
            reports?: components["schemas"]["DailyMonthlyReportListVO"][];
        };
        DailyMonthlyReportListVO: {
            /** @description 用户ID */
            userId?: string;
            /** @description 日月报记录 */
            reports?: components["schemas"]["DailyMonthlyReportDetailVO"][];
        };
        ...
        ServiceResultLoginSuccessVO: {
            code?: string;
            success?: boolean;
            data?: components["schemas"]["LoginSuccessVO"];
            message?: string;
            tid?: string;
        };
        HrCompanyRegisterRO: {
        ...
        DataPermissionRelationVO: {
            ...
            userByDept?: components["schemas"]["DataPermissionRelationDetailVO"][];
            /** @description 通过用户组选择的查看人 */
            userByGroup?: components["schemas"]["DataPermissionRelationDetailVO"][];
            /** @description 直接选择人的查看人 */
            userIdList?: string[];
            /** @description 通过部门选择的被查看人 */
            viewedByDept?: components["schemas"]["DataPermissionRelationDetailVO"][];
            /** @description 通过用户组选择的被查看人 */
            viewedByGroup?: components["schemas"]["DataPermissionRelationDetailVO"][];
        ...
        ServiceResultListDocumentInfo: {
            code?: string;
            success?: boolean;
            data?: components["schemas"]["DocumentInfo"][];
            message?: string;
            tid?: string;
        };
        DocumentCatVO: {
            ...
            /** @description 字典类型名称 */
            dictTypeName?: string;
            documentInfoList?: components["schemas"]["DocumentInfo"][];
        };
        ServiceResultIPageDocumentInfoES: {
            code?: string;
            success?: boolean;
            data?: components["schemas"]["IPageDocumentInfoES"];
            message?: string;
            tid?: string;
        };
        ClockROCreate: {
        ...
        ServiceResultPageClockWayVO: {
            ...
            success?: boolean;
            /** @description 主数据 */
            data?: components["schemas"]["PageClockWayVO"];
            /** @description 业务状态消息 */
            message?: string;
            /** @description trace id */
            tid?: string;
        ...
        ServiceResultPageProjectListVO: {
            ...
            success?: boolean;
            /** @description 主数据 */
            data?: components["schemas"]["PageProjectListVO"];
            /** @description 业务状态消息 */
            message?: string;
            /** @description trace id */
            tid?: string;
        ...
        PayrollFileInitRst: {
            token?: string;
            payrollList?: components["schemas"]["PayrollDetail"][];
        };
        PayrollExcelDynamicDataVO: {
            detail?: components["schemas"]["MapObject"][];
            headers?: components["schemas"]["ExcelHeaderItem"][];
        ...
        ServiceResultPageTeamEmployeeVO: {
            ...
            success?: boolean;
            /** @description 主数据 */
            data?: components["schemas"]["PageTeamEmployeeVO"];
            /** @description 业务状态消息 */
            message?: string;
            /** @description trace id */
            tid?: string;
        ...
        OvertimeCalculateRule: {
            ...
            deductType: number;
            /** @description 休息时段 */
            breakTimePeriods?: components["schemas"]["TimePeriod"][];
            /** @description 时长扣除规则 */
            deductRules?: components["schemas"]["TieredTime"][];
            /**
        ...
        MenuDTO: {
            ...
            pCode?: string;
            routeUrl?: string;
            powerMapList?: components["schemas"]["PowerDTO"][];
            /** Format: int64 */
            roleNo?: number;
            /** @description 日志标识 */
            descs?: string;
        ...
        PageSysDictData: {
            records?: components["schemas"]["SysDictData"][];
            /** Format: int64 */
            total?: number;
            /** Format: int64 */
            size?: number;
        ...
        DeptWithConflictOrgDept: {
            /** @description 部门信息 */
            dept?: components["schemas"]["OrgDept"];
            /** @description 是否存在冲突 */
            exists?: boolean;
        ...
        ServiceResultFieldMatchResponse: {
            code?: string;
            success?: boolean;
            data?: components["schemas"]["FieldMatchResponse"];
            message?: string;
            tid?: string;
        };
        "EmptyValueSetHandler?": Record<string, never>;
        DeptExportRO: {
            exportFields?: components["schemas"]["ExportField"][];
        ...
        ServiceResultListAppraiseConfigVO: {
            code?: string;
            success?: boolean;
            data?: components["schemas"]["AppraiseConfigVO"][];
            message?: string;
            tid?: string;
        };
        ...
        ServiceResultPageStaffRosterDataVO: {
            code?: string;
            success?: boolean;
            data?: components["schemas"]["PageStaffRosterDataVO"];
            message?: string;
            tid?: string;
        };
        ...
        AppraiseTableDetailVO: {
            ...
            personalPhoto?: string;
            /** @description 考核内容 */
            detailList?: components["schemas"]["AppriasePostTableGroupVO"][];
            /** @description KPI */
            kpiList?: components["schemas"]["AppriasePostTableItemVO"][];
            /** @description 考核修正 */
            reviseList?: components["schemas"]["AppriasePostTableGroupVO"][];
            /** @description 考核管理 */
            configList?: components["schemas"]["AppraisePostTableConfig"][];
        };
        DocFileDTO: {
            /**
             * @description 页码
        ...
        ServiceResultTeamCalendarDisplaySettingVO: {
            code?: string;
            success?: boolean;
            data?: components["schemas"]["TeamCalendarDisplaySettingVO"];
            message?: string;
            tid?: string;
        };
        FieldMatchInfo: {
        ...
        StaffExportParam: {
            ...
            /** @description 排序规则 */
            order?: components["schemas"]["OrderCondition"][];
        };
        StaffSelectionDetailVO: {
            ...
            id?: number;
            /** @description 选中的条件 */
            conditions?: components["schemas"]["SelectionCondition"][];
            /** @description 是否全公司 */
            all?: boolean;
            /** @description 是否本部门 */
            ownerDept?: boolean;
        ...
        ServiceResultListDailyMonthlyReportVO: {
            code?: string;
            success?: boolean;
            data?: components["schemas"]["DailyMonthlyReportVO"][];
            message?: string;
            tid?: string;
        };
        ...
        UserGroupDetailVO: {
            ...
            /** @description 选择器数据 */
            selectionDetailVO?: components["schemas"]["StaffSelectionDetailVO"];
        };
        DataPermissionDetailVO: {
            ...
            permissionRelation?: components["schemas"]["DataPermissionRelationVO"][];
        };
        ServiceResultCompanyUserStatusStatisticsVO: {
            ...
            success?: boolean;
            /** @description 主数据 */
            data?: components["schemas"]["CompanyUserStatusStatisticsVO"];
            /** @description 业务状态消息 */
            message?: string;
            /** @description trace id */
            tid?: string;
        ...
        ServiceResultListDocumentCatVO: {
            code?: string;
            success?: boolean;
            data?: components["schemas"]["DocumentCatVO"][];
            message?: string;
            tid?: string;
        };
        ProjectListDTO: {
        ...
        Payroll: {
            ...
            detailDynamicList?: components["schemas"]["PayrollDetailDynamic"][];
            payrollFileInitRst?: components["schemas"]["PayrollFileInitRst"];
            payrollExcelDynamicDataVO?: components["schemas"]["PayrollExcelDynamicDataVO"];
        };
        HelpES: {
            /**
             * Format: int64
        ...
        ServiceResultPayrollExcelDynamicDataVO: {
            code?: string;
            success?: boolean;
            data?: components["schemas"]["PayrollExcelDynamicDataVO"];
            message?: string;
            tid?: string;
        };
        BaseDeleteDTO: {
        ...
        AttendanceReport: {
            /** @description 考勤概况 */
            generalSituation?: components["schemas"]["ShiftAccountGeneralSituation"];
            /** @description 异常统计 */
            abnormalStatistics?: components["schemas"]["AttendanceAbnormalStatistics"];
        };
        ...
        ServiceResultListBngRole: {
            code?: string;
            success?: boolean;
            data?: components["schemas"]["BngRole"][];
            message?: string;
            tid?: string;
        };
        ServiceResultListBngCompany: {
            code?: string;
            success?: boolean;
            data?: components["schemas"]["BngCompany"][];
            message?: string;
            tid?: string;
        };
        ...
        ServiceResultPageSysDictData: {
            code?: string;
            success?: boolean;
            data?: components["schemas"]["PageSysDictData"];
            message?: string;
            tid?: string;
        };
        ServiceResultCompanyThirdPartyConfig: {
            code?: string;
            success?: boolean;
            data?: components["schemas"]["CompanyThirdPartyConfig"];
            message?: string;
            tid?: string;
        };
        ...
        ServiceResultSysLoginDevice: {
            code?: string;
            success?: boolean;
            data?: components["schemas"]["SysLoginDevice"];
            message?: string;
            tid?: string;
        };
        ExportBaseRequestDeptExportRO: {
            type: string;
            param?: components["schemas"]["DeptExportRO"];
        };
        CustomFieldCreateROCreate: {
            /** Format: int64 */
            id?: number;
            currentUser?: components["schemas"]["LoginCacheCreate"];
        ...
        ServiceResultAppraiseItem: {
            code?: string;
            success?: boolean;
            data?: components["schemas"]["AppraiseItem"];
            message?: string;
            tid?: string;
        };
        AppraiseGroupVO: {
            ...
            dictTypeName?: string;
            /** @description 指标 */
            itemList?: components["schemas"]["AppraiseItemVO"][];
            /** @description 包含指标数量 */
            counts?: number;
        };
        HrEditROModify: {
        ...
        RatingConfig: {
            ratings?: components["schemas"]["RatingLevel"][];
            /**
        ...
        MapListCustomFieldConfigItemCreate: {
            key?: components["schemas"]["keyCreate"][];
        };
        OrderConditionQuery: {
            /** @description 排序字段 */
            orderBy?: string;
        ...
        ServiceResultAppraiseTableDetailVO: {
            code?: string;
            success?: boolean;
            data?: components["schemas"]["AppraiseTableDetailVO"];
            message?: string;
            tid?: string;
        };
        ...
        ExportBaseRequestStaffExportParam: {
            type: string;
            param?: components["schemas"]["StaffExportParam"];
        };
        DocFilePresignedVO: {
            /**
             * Format: int64
        ...
        ServiceResultStaffSelectionDetailVO: {
            code?: string;
            success?: boolean;
            data?: components["schemas"]["StaffSelectionDetailVO"];
            message?: string;
            tid?: string;
        };
        ...
        ServiceResultListDailyMonthlyReportListVO: {
            code?: string;
            success?: boolean;
            data?: components["schemas"]["DailyMonthlyReportListVO"][];
            message?: string;
            tid?: string;
        };
        ...
        ServiceResultUserGroupDetailVO: {
            code?: string;
            success?: boolean;
            data?: components["schemas"]["UserGroupDetailVO"];
            message?: string;
            tid?: string;
        };
        ServiceResultDataPermissionDetailVO: {
            code?: string;
            success?: boolean;
            data?: components["schemas"]["DataPermissionDetailVO"];
            message?: string;
            tid?: string;
        };
        ForceGroup: {
        ...
        ServiceResultListPositionLevelVO: {
            ...
            success?: boolean;
            /** @description 主数据 */
            data?: components["schemas"]["PositionLevelVO"][];
            /** @description 业务状态消息 */
            message?: string;
            /** @description trace id */
            tid?: string;
        ...
        ProjectDetailVO: {
            ...
            createTime?: string;
            /** @description 任务组 */
            children?: components["schemas"]["ProjectDetailVO"][];
            /** @description 参与人选择器条件 */
            conditions?: components["schemas"]["SelectionCondition"][];
            /** @description 项目附件列表 */
            attachmentList?: components["schemas"]["ProjectAttachmentListVO"][];
            /** @description 项目参与人列表 */
            participantList?: components["schemas"]["ProjectParticipantListVO"][];
        };
        ServiceResultPayrollFileInitRst: {
            code?: string;
            success?: boolean;
            data?: components["schemas"]["PayrollFileInitRst"];
            message?: string;
            tid?: string;
        };
        HrmStaffBaseInfo: {
            ...
            /** @description 三方 */
            third?: string;
            currentCompany?: components["schemas"]["HrCompanySummaryVO"];
            companyList?: components["schemas"]["HrCompanySummaryVO"][];
            /** Format: int64 */
            softVersionId?: number;
            orderNo?: number;
        };
        ...
        ServiceResultOrgDept: {
            code?: string;
            success?: boolean;
            data?: components["schemas"]["OrgDept"];
            message?: string;
            tid?: string;
        };
        ExportTaskInfo: {
        ...
        DynamicExcelHandleRequestStaffImportParam: {
            ...
            dataFields: components["schemas"]["FieldMatchInfo"][];
        };
        FieldOption: {
            /** @description 选项值 */
            option?: string;
        ...
        BngVersionPackageCreate: {
            ...
            softName?: string;
            domain?: string;
            adminUser?: components["schemas"]["BngUserCreate"][];
        };
        FileUrlQueryVO: {
            /** @description 文件下载链接 */
            fileUrl?: string;
        ...
        ServiceResultListAppraiseGroupVO: {
            code?: string;
            success?: boolean;
            data?: components["schemas"]["AppraiseGroupVO"][];
            message?: string;
            tid?: string;
        };
        ServiceResultAppraiseConfig: {
            code?: string;
            success?: boolean;
            data?: components["schemas"]["AppraiseConfig"];
            message?: string;
            tid?: string;
        };
        TargetBasedConfig: {
        ...
        ServiceResultMapListAppraiseItemPostNumsVO: {
            code?: string;
            success?: boolean;
            data?: components["schemas"]["MapListAppraiseItemPostNumsVO"];
            message?: string;
            tid?: string;
        };
        TeamCalendarTaskQueryItemVO: {
            ...
            taskList?: components["schemas"]["TaskItemVO"][];
        };
        DeptExportParam: {
            exportFields?: components["schemas"]["ExportField"][];
            /** @default false */
        ...
        DocFileUploadSummary: {
            ...
            /** @description timestamp  时间戳 */
            ts?: string;
            files?: components["schemas"]["DocFilePresignedVO"][];
            staffName?: string;
            photo?: string;
        };
        ServiceResultListTeamCalendarTaskVO: {
            code?: string;
            success?: boolean;
            data?: components["schemas"]["TeamCalendarTaskVO"][];
            message?: string;
            tid?: string;
        };
        DocNoticeTypeCntVO: {
        ...
        TeamCalendarSettingCreateModifyDTO: {
            ...
            taskKeyDisplayItems: components["schemas"]["TaskKeyDisplayItem"][];
        };
        WorkPlanDetailVO: {
            /** @description 记录ID */
            recordId?: string;
            ...
            executorCondition?: components["schemas"]["SelectionCondition"][];
            /** @description 执行时间 */
            executorTime?: string;
            /** @description 标题 */
            title?: string;
            ...
            tenantId?: string;
            /** @description 附件列表 */
            attachmentList?: components["schemas"]["WorkPlanAttachmentVO"][];
            /** @description 执行人信息 */
            executorList?: components["schemas"]["WorkPlanExecutorVO"][];
            processRecordList?: components["schemas"]["WorkPlanProcessRecordVO"][];
        };
        ...
        ForceStaffProject: {
            ...
            /** @description 分数 */
            score?: number;
            groupList?: components["schemas"]["ForceGroup"][];
        };
        ServiceResultValidateSmsCodeVO: {
            code?: string;
            success?: boolean;
            data?: components["schemas"]["ValidateSmsCodeVO"];
            message?: string;
            tid?: string;
        };
        ServiceResultJSONArray: {
            ...
            success?: boolean;
            /** @description 主数据 */
            data?: components["schemas"]["JSONArray"][];
            /** @description 业务状态消息 */
            message?: string;
            /** @description trace id */
            tid?: string;
        ...
        IPageHelpES: {
            records?: components["schemas"]["HelpES"][];
            /** Format: int64 */
            total?: number;
            /** Format: int64 */
            size?: number;
        ...
        OvertimeStatistics: {
            ...
            /** @description 加班明细 */
            details?: components["schemas"]["OvertimeStatisticsDetail"][];
        };
        BngUser: {
            /**
             * Format: int64
        ...
        ServiceResultExportTaskInfo: {
            code?: string;
            success?: boolean;
            data?: components["schemas"]["ExportTaskInfo"];
            message?: string;
            tid?: string;
        };
        TaskListRequest: {
        ...
        ServiceResultFileUrlQueryVO: {
            code?: string;
            success?: boolean;
            data?: components["schemas"]["FileUrlQueryVO"];
            message?: string;
            tid?: string;
        };
        RangeItem: {
        ...
        ServiceResultListTeamCalendarTaskQueryItemVO: {
            code?: string;
            success?: boolean;
            data?: components["schemas"]["TeamCalendarTaskQueryItemVO"][];
            message?: string;
            tid?: string;
        };
        ExportBaseRequestDeptExportParam: {
            type: string;
            param?: components["schemas"]["DeptExportParam"];
        };
        PageDocFileUploadSummary: {
            records?: components["schemas"]["DocFileUploadSummary"][];
            /** Format: int64 */
            total?: number;
            /** Format: int64 */
            size?: number;
        ...
        ServiceResultListDocNoticeTypeCntVO: {
            ...
            success?: boolean;
            /** @description 主数据 */
            data?: components["schemas"]["DocNoticeTypeCntVO"][];
            /** @description 业务状态消息 */
            message?: string;
            /** @description trace id */
            tid?: string;
        ...
        ServiceResultListTeamCalendarSettingVO: {
            code?: string;
            success?: boolean;
            data?: components["schemas"]["TeamCalendarSettingVO"][];
            message?: string;
            tid?: string;
        };
        ...
        ServiceResultWorkPlanDetailVO: {
            code?: string;
            success?: boolean;
            data?: components["schemas"]["WorkPlanDetailVO"];
            message?: string;
            tid?: string;
        };
        ServiceResultDailyMonthlyReportDetailVO: {
            code?: string;
            success?: boolean;
            data?: components["schemas"]["DailyMonthlyReportDetailVO"];
            message?: string;
            tid?: string;
        };
        ChangeCompanyRO: {
        ...
        ForceDept: {
            ...
            staffNums?: number;
            /** @description 统计 */
            summary?: components["schemas"]["AppraiseGradeDistribution"][];
            /** @description 子部门 */
            children?: components["schemas"]["ForceDept"][];
            staffProjectList?: components["schemas"]["ForceStaffProject"][];
        };
        PageCompanyAccountVO: {
            records?: components["schemas"]["CompanyAccountVO"][];
            /** Format: int64 */
            total?: number;
            /** Format: int64 */
            size?: number;
        ...
        SearchVO: {
            staffs?: components["schemas"]["OrgDeptStaff"][];
            depts?: components["schemas"]["OrgDeptsLess"][];
        };
        ...
        ServiceResultIPageHelpES: {
            code?: string;
            success?: boolean;
            data?: components["schemas"]["IPageHelpES"];
            message?: string;
            tid?: string;
        };
        ...
        BngVersionPackage: {
            ...
            softName?: string;
            domain?: string;
            adminUser?: components["schemas"]["BngUser"][];
        };
        ServiceResultMapObject: {
            code?: string;
            success?: boolean;
            data?: components["schemas"]["MapObject"];
            message?: string;
            tid?: string;
        };
        ServiceResultListSysDictData: {
            ...
            success?: boolean;
            /** @description 主数据 */
            data?: components["schemas"]["SysDictData"][];
            /** @description 业务状态消息 */
            message?: string;
            /** @description trace id */
            tid?: string;
        ...
        SyncPreviewResult: {
            ...
            deptsToSave?: components["schemas"]["OrgDept"][];
            /** @description 待更新父部门ID的部门列表 */
            deptsToUpdate?: components["schemas"]["OrgDept"][];
            /** @description 冲突的部门列表（已存在） */
            conflictDepts?: components["schemas"]["OrgDept"][];
            /** @description 待保存的员工列表 */
            staffsToSave?: components["schemas"]["HrmStaffBaseInfo"][];
            /** @description 冲突的员工列表（已存在或姓名重复） */
            conflictStaffs?: components["schemas"]["HrmStaffBaseInfo"][];
            /** @description 预览说明信息 */
            message?: string;
        };
        DeptImportParam: {
        ...
        ServiceResultCustomFieldVO: {
            code?: string;
            success?: boolean;
            data?: components["schemas"]["CustomFieldVO"];
            message?: string;
            tid?: string;
        };
        BngCompanyCreate: {
            ...
            bngVersionPackage?: components["schemas"]["BngVersionPackageCreate"][];
            logs?: components["schemas"]["OrderLogCreate"][];
            /** Format: int64 */
            versionId?: number;
            /** Format: int64 */
            softId?: number;
        ...
        PercentageRangeConfig: {
            ranges?: components["schemas"]["RangeItem"][];
            /**
             * @description 权重
             * @default 100
             */
        ...
        ServiceResultListAppraiseItemPostNumsVO: {
            code?: string;
            success?: boolean;
            data?: components["schemas"]["AppraiseItemPostNumsVO"][];
            message?: string;
            tid?: string;
        };
        StaffDetailVO: {
            ...
            id?: number;
            /** @description 字段分组 */
            fieldGroups?: components["schemas"]["StaffFieldBusinessPointConfigVO"][];
        };
        DocFolderSaveDTO: {
            /**
             * Format: int64
        ...
        ServiceResultPageDocFileUploadSummary: {
            ...
            success?: boolean;
            /** @description 主数据 */
            data?: components["schemas"]["PageDocFileUploadSummary"];
            /** @description 业务状态消息 */
            message?: string;
            /** @description trace id */
            tid?: string;
        ...
        ServiceResultListTeamCalendarTaskQueryListVO: {
            ...
            success?: boolean;
            /** @description 主数据 */
            data?: components["schemas"]["TeamCalendarTaskQueryListVO"][];
            /** @description 业务状态消息 */
            message?: string;
            /** @description trace id */
            tid?: string;
        ...
        TeamCalendarSettingQueryVO: {
            ...
            taskKeyDisplayItems?: components["schemas"]["TaskKeyDisplayItem5"][];
        };
        ServiceResultListSelectionCondition: {
            code?: string;
            success?: boolean;
            data?: components["schemas"]["SelectionCondition"][];
            message?: string;
            tid?: string;
        };
        NoticeDExportParam: {
        ...
        DailyMonthlyReportRecordsDTO: {
            ...
            address?: string;
            /** @description 附件 */
            attachments?: components["schemas"]["DailyMonthlyReportRecordsAttachmentDTO"][];
        };
        BngRoleVO: {
            /**
             * Format: int64
        ...
        AppraiseForceRuleVO: {
            ...
            /** @description 是否已校准 0 未校准 1 已校准 */
            ifResetStatus?: number;
            deptList?: components["schemas"]["ForceDept"][];
            /** @description key 是 sabcd value 是对应的员工考核表 */
            scoreList?: components["schemas"]["MapListForceStaffProject"];
        };
        PasswordSetRO: {
        ...
        ServiceResultPageCompanyAccountVO: {
            ...
            success?: boolean;
            /** @description 主数据 */
            data?: components["schemas"]["PageCompanyAccountVO"];
            /** @description 业务状态消息 */
            message?: string;
            /** @description trace id */
            tid?: string;
        ...
        ServiceResultSearchVO: {
            ...
            success?: boolean;
            /** @description 主数据 */
            data?: components["schemas"]["SearchVO"];
            /** @description 业务状态消息 */
            message?: string;
            /** @description trace id */
            tid?: string;
        ...
        DailyReportVO: {
            ...
            dayType?: number;
            /** @description 员工基础信息 */
            staffInfo?: components["schemas"]["StaffBaseInfo"];
            /** @description 考勤班次报表 */
            shiftReport?: components["schemas"]["AttendanceReport"];
            /** @description 加班统计 */
            overtimeStatistics?: components["schemas"]["OvertimeStatistics"];
            /** @description 假勤统计 */
            flowStatistics?: components["schemas"]["AttendanceFlowStatistics"];
        };
        OrderLog: {
            /**
             * Format: int64
        ...
        ExportBaseRequestStaffExportRO: {
            type: string;
            param?: components["schemas"]["StaffExportRO"];
        };
        ServiceResultSyncPreviewResult: {
            code?: string;
            success?: boolean;
            data?: components["schemas"]["SyncPreviewResult"];
            message?: string;
            tid?: string;
        };
        DynamicExcelHandleRequestDeptImportParam: {
            type: string;
            taskParam?: components["schemas"]["DeptImportParam"];
            /** @description 源文件url */
            excelFileUrl: string;
            /** @description 原文件名 */
            fileName: string;
        ...
        LoginCacheCreate: {
            ...
            userId?: number;
            token?: string;
            bngUser?: components["schemas"]["BngUserCreate"];
            lastLoginTime?: string;
            companyList?: components["schemas"]["BngCompanyCreate"][];
            currentBngCompany?: components["schemas"]["BngCompanyCreate"];
            /** Format: int64 */
        ...
        StaffRoster: {
            ...
            marriage?: string;
            /** @description 自定义字段 */
            customFields?: components["schemas"]["MapFieldValueVO"];
        };
        StaffFieldGroupVO: {
            /**
             * Format: int64
        ...
        ServiceResultStaffDetailVO: {
            ...
            success?: boolean;
            /** @description 主数据 */
            data?: components["schemas"]["StaffDetailVO"];
            /** @description 业务状态消息 */
            message?: string;
            /** @description trace id */
            tid?: string;
        ...
        TeamCalendarTaskQuerySelfCreateVO: {
            ...
            noticeStaffInfos?: components["schemas"]["TeamCalendarTaskNoticeStaffInoVO"][];
            /** @description 附件信息 */
            attachments?: components["schemas"]["TeamCalendarTaskAttachmentVo"][];
        };
        ...
        DocNoticeD: {
            ...
            staffSigns?: components["schemas"]["StaffSignLessVO"][];
        };
        DocNoticeRange: {
            /**
             * Format: int64
        ...
        ServiceResultTeamCalendarSettingQueryVO: {
            ...
            success?: boolean;
            /** @description 主数据 */
            data?: components["schemas"]["TeamCalendarSettingQueryVO"];
            /** @description 业务状态消息 */
            message?: string;
            /** @description trace id */
            tid?: string;
        ...
        ExportBaseRequestNoticeDExportParam: {
            ...
            param?: components["schemas"]["NoticeDExportParam"];
        };
        WorkPlanCreateDTO: {
            /** @description 父级工作计划ID */
            parentId?: string;
            ...
            /** @description 附件列表 */
            attachments?: components["schemas"]["WorkPlanAttachmentDTO"][];
            /** @description 子任务 */
            children?: components["schemas"]["WorkPlanCreateDTO"][];
        };
        ...
        ServiceResultListBngRoleVO: {
            code?: string;
            success?: boolean;
            data?: components["schemas"]["BngRoleVO"][];
            message?: string;
            tid?: string;
        };
        UserGroupEditDTO: {
        ...
        AppraiseRestVO: {
            ...
            ruleList?: components["schemas"]["AppraiseForceRuleVO"][];
        };
        PasswordUpdateRO: {
            /** @description 新密码（RSA加密串） */
            password: string;
        ...
        ServiceResultPageOvertimeRuleVO: {
            ...
            success?: boolean;
            /** @description 主数据 */
            data?: components["schemas"]["PageOvertimeRuleVO"];
            /** @description 业务状态消息 */
            message?: string;
            /** @description trace id */
            tid?: string;
        ...
        StaffCustomFieldCreateROCreate: {
            ...
            options?: string[];
            /** @description 字段配置表 */
            configItems?: components["schemas"]["CustomFieldConfigCreate"][];
        };
        ServiceResultListStaffFieldGroupVO: {
            code?: string;
            success?: boolean;
            data?: components["schemas"]["StaffFieldGroupVO"][];
            message?: string;
            tid?: string;
        };
        CompletionRatioConfig: {
            ...
            targetRatio?: number;
            coefficientRanges?: components["schemas"]["CoefficientRange"][];
            /**
        ...
        CustomFieldConfigCreate: {
            ...
            point: string;
            configs: components["schemas"]["FieldItemConfigCreate"][];
        };
        ...
        ServiceResultListTeamCalendarTaskQuerySelfCreateVO: {
            code?: string;
            success?: boolean;
            data?: components["schemas"]["TeamCalendarTaskQuerySelfCreateVO"][];
            message?: string;
            tid?: string;
        };
        MapLong: {
        ...
        DocNotice: {
            ...
            fileList?: components["schemas"]["DocNoticeFile"][];
            /** @description 公文下的阅读集合 */
            dList?: components["schemas"]["DocNoticeD"][];
            /** @description 公文下的附件集合(阅读) */
            readFiles?: components["schemas"]["DocFilePresignedVO"][];
            ...
            userReadOrSignDetail?: components["schemas"]["DocNoticeD"];
            /**
             * Format: int64
             * @description 要求的员工总数
             */
            ...
            staffSelectionDetail?: components["schemas"]["StaffSelectionDetailVO"];
        };
        SelectionConditionCreate: {
            ...
            operator?: 1 | 2 | 3 | 4 | 5;
            /** @description 维度数据 */
            data?: components["schemas"]["StaffDimensionDataCreate"][];
        };
        WorkPlanEditDTO: {
            /** @description 主键ID */
            id?: string;
        ...
        ServiceResultAppraiseRestVO: {
            code?: string;
            success?: boolean;
            data?: components["schemas"]["AppraiseRestVO"];
            message?: string;
            tid?: string;
        };
        MobileSmsCodeRO: {
        ...
        PageDailyReportVO: {
            records?: components["schemas"]["DailyReportVO"][];
            /** Format: int64 */
            total?: number;
            /** Format: int64 */
            size?: number;
        ...
        BngCompany: {
            ...
            /** Format: int64 */
            registerSoftId?: number;
            bngVersionPackage?: components["schemas"]["BngVersionPackage"][];
            logs?: components["schemas"]["OrderLog"][];
            /** Format: int64 */
            versionId?: number;
            /** Format: int64 */
            softId?: number;
        ...
        PageOrgDeptAttribute: {
            records?: components["schemas"]["OrgDeptAttribute"][];
            /** Format: int64 */
            total?: number;
            /** Format: int64 */
            size?: number;
        ...
        StaffWithConflictHrmStaffBaseInfo: {
            /** @description 用户信息 */
            staff?: components["schemas"]["HrmStaffBaseInfo"];
            /** @description 是否存在冲突 */
            exists?: boolean;
            /** @description 是否存在冲突 */
            nameexists?: boolean;
        ...
        PageStaffRoster: {
            records?: components["schemas"]["StaffRoster"][];
            /** Format: int64 */
            total?: number;
            /** Format: int64 */
            size?: number;
        ...
        ServiceResultAppraiseImportResult: {
            code?: string;
            success?: boolean;
            data?: components["schemas"]["AppraiseImportResult"];
            message?: string;
            tid?: string;
        };
        FieldValueModify: {
        ...
        DocFileSpaceVO: {
            ...
            userUsedFileTypeSizeSum?: components["schemas"]["MapLong"];
            /**
             * Format: int64
             * @description 用户使用的总计
             */
        ...
        StaffSelectionConditionDataCreate: {
            ...
            id?: number;
            /** @description 条件列表 */
            conditions?: components["schemas"]["SelectionConditionCreate"][];
        };
        ...
        ServiceResultPageDailyReportVO: {
            code?: string;
            success?: boolean;
            data?: components["schemas"]["PageDailyReportVO"];
            message?: string;
            tid?: string;
        };
        LoginCache: {
            ...
            userId?: number;
            token?: string;
            bngUser?: components["schemas"]["BngUser"];
            lastLoginTime?: string;
            companyList?: components["schemas"]["BngCompany"][];
            currentBngCompany?: components["schemas"]["BngCompany"];
            /** Format: int64 */
            currentSoftId?: number;
            /** Format: int64 */
            currentSoftVersionId?: number;
            ...
            coNo?: number;
            isAdmin?: number;
            currentSoftRoleList?: components["schemas"]["BngRole"][];
            showCompanyList?: number;
        };
        ServiceResultOvertimeRuleVO: {
            ...
            success?: boolean;
            /** @description 主数据 */
            data?: components["schemas"]["OvertimeRuleVO"];
            /** @description 业务状态消息 */
            message?: string;
            /** @description trace id */
            tid?: string;
        ...
        ServiceResultPageOrgDeptAttribute: {
            code?: string;
            success?: boolean;
            data?: components["schemas"]["PageOrgDeptAttribute"];
            message?: string;
            tid?: string;
        };
        TimePeriodCreate: {
        ...
        ServiceResultPageSysDictType: {
            code?: string;
            success?: boolean;
            data?: components["schemas"]["PageSysDictType"];
            message?: string;
            tid?: string;
        };
        SyncResult: {
            deptResults?: components["schemas"]["DeptWithConflictOrgDept"][];
            staffResults?: components["schemas"]["StaffWithConflictHrmStaffBaseInfo"][];
            checkMsg?: string;
            companySyncRecord?: components["schemas"]["CompanySyncRecord"];
        };
        StaffCustomFieldVO: {
            /**
             * Format: int64
            ...
            optionItems?: components["schemas"]["FieldOptionItem"][];
        };
        ServiceResultPageStaffRoster: {
            code?: string;
            success?: boolean;
            data?: components["schemas"]["PageStaffRoster"];
            message?: string;
            tid?: string;
        };
        ...
        ServiceResultDocFile: {
            ...
            success?: boolean;
            /** @description 主数据 */
            data?: components["schemas"]["DocFile"];
            /** @description 业务状态消息 */
            message?: string;
            /** @description trace id */
            tid?: string;
        ...
        ServiceResultListTeamCalendarTaskNoticeUserVO: {
            code?: string;
            success?: boolean;
            data?: components["schemas"]["TeamCalendarTaskNoticeUserVO"][];
            message?: string;
            tid?: string;
        };
        AppraiseStaffTarget: {
        ...
        ServiceResultDocFileSpaceVO: {
            ...
            success?: boolean;
            /** @description 主数据 */
            data?: components["schemas"]["DocFileSpaceVO"];
            /** @description 业务状态消息 */
            message?: string;
            /** @description trace id */
            tid?: string;
        ...
        PageTeamCalendarTaskQuerySelfCreateVO: {
            records?: components["schemas"]["TeamCalendarTaskQuerySelfCreateVO"][];
            /** Format: int64 */
            total?: number;
            /** Format: int64 */
            size?: number;
        ...
        PageDocNotice: {
            records?: components["schemas"]["DocNotice"][];
            /** Format: int64 */
            total?: number;
            /** Format: int64 */
            size?: number;
        ...
        HrmStaffBaseInfoQuery: {
            ...
            personalPhoto?: string;
            planRegularDate?: string;
            currentCompany?: components["schemas"]["BngCompanyQuery"];
            loginCache?: components["schemas"]["LoginCacheQuery"];
        };
        ServiceResultLoginCache: {
            ...
            errorCode?: number;
            message?: string;
            data?: components["schemas"]["LoginCache"];
        };
        ...
        ServiceResultOrgDeptAttribute: {
            code?: string;
            success?: boolean;
            data?: components["schemas"]["OrgDeptAttribute"];
            message?: string;
            tid?: string;
        };
        TieredTimeCreate: {
        ...
        ServiceResultStaffCustomFieldVO: {
            code?: string;
            success?: boolean;
            data?: components["schemas"]["StaffCustomFieldVO"];
            message?: string;
            tid?: string;
        };
        FieldOptionItem: {
        ...
        CustomFieldConfig: {
            /** @description 业务端点（STAFF_DETAIL: 员工端员工档案, STAFF_ENTRY_REGISTRATION: 员工端入职登记表, ADMIN_ADD_STAFF: 管理端添加人员） */
            point?: string;
            configs?: components["schemas"]["FieldItemConfig"][];
        };
        ServiceResultPageTeamCalendarTaskQuerySelfCreateVO: {
            ...
            success?: boolean;
            /** @description 主数据 */
            data?: components["schemas"]["PageTeamCalendarTaskQuerySelfCreateVO"];
            /** @description 业务状态消息 */
            message?: string;
            /** @description trace id */
            tid?: string;
        ...
        ServiceResultPageDocNotice: {
            ...
            success?: boolean;
            /** @description 主数据 */
            data?: components["schemas"]["PageDocNotice"];
            /** @description 业务状态消息 */
            message?: string;
            /** @description trace id */
            tid?: string;
        ...
        AppraiseForceResetListQueryDTO: {
            ...
            key?: string;
            totalCount?: number;
            rule?: components["schemas"]["AppraiseConfigForcedRule"];
        };
        PasswordResetRO: {
            uuid?: string;
            password?: string;
        ...
        ProjectCreateDTO: {
            ...
            participantSelectionId?: string;
            /** @description 附件列表 */
            attachmentList?: components["schemas"]["ProjectAttachmentDTO"][];
        };
        ...
        DateRangeReportROQuery: {
            /** Format: int64 */
            coNo?: number;
            currentStaff?: components["schemas"]["HrmStaffBaseInfoQuery"];
            /** @description 部门ID列表 */
            deptNos?: number[];
            /** @description 员工ID列表 */
            staffNos?: number[];
        ...
        OvertimeCalculateRuleCreate: {
            ...
            deductType?: number;
            /** @description 休息时段 */
            breakTimePeriods?: components["schemas"]["TimePeriodCreate"][];
            /** @description 时长扣除规则 */
            deductRules?: components["schemas"]["TieredTimeCreate"][];
            /**
             * @description 下班后多久开始计算加班（单位：分钟）
             * @default 0
             */
        ...
        DocDir: {
            ...
            /** @description 权限集合 */
            rangePowers?: components["schemas"]["DocDirRange"][];
        };
        ...
        PageWorkPlanAnnotationVO: {
             ...
             * @default Collections.emptyList()
             */
            records: components["schemas"]["WorkPlanAnnotationVO"][];
            /**
             * Format: int64
             * @description 总数
             * @default 0
        ...
        ServiceResultTaskViewFollowConfigVO: {
            code?: string;
            success?: boolean;
            data?: components["schemas"]["TaskViewFollowConfigVO"];
            message?: string;
            tid?: string;
        };
        TaskViewConfigVO: {
        ...
        ProjectEditDTO: {
            ...
            participantSelectionId?: string;
            /** @description 附件列表 */
            atachmentList?: components["schemas"]["ProjectAttachmentDTO"][];
        };
        ...
        BngVersionPackageEdit: {
            ...
            softName?: string;
            domain?: string;
            adminUser?: components["schemas"]["BngUserEdit"][];
        };
        PageOrgEnterpriseSubject: {
            records?: components["schemas"]["OrgEnterpriseSubject"][];
            /** Format: int64 */
            total?: number;
            /** Format: int64 */
            size?: number;
        ...
        PageCompanySyncRecord: {
            records?: components["schemas"]["CompanySyncRecord"][];
            /** Format: int64 */
            total?: number;
            /** Format: int64 */
            size?: number;
        ...
        ServiceResultStaffFieldConfigDetailVO: {
            code?: string;
            success?: boolean;
            data?: components["schemas"]["StaffFieldConfigDetailVO"];
            message?: string;
            tid?: string;
        };
        AppraiseItemVO: {
        ...
        PageDocDir: {
            records?: components["schemas"]["DocDir"][];
            /** Format: int64 */
            total?: number;
            /** Format: int64 */
            size?: number;
        ...
        ServiceResultDocNotice: {
            ...
            success?: boolean;
            /** @description 主数据 */
            data?: components["schemas"]["DocNotice"];
            /** @description 业务状态消息 */
            message?: string;
            /** @description trace id */
            tid?: string;
        ...
        PageStaffSelectionResult: {
            records?: components["schemas"]["StaffSelectionResult"][];
            /** Format: int64 */
            total?: number;
            /** Format: int64 */
            size?: number;
        ...
        ServiceResultPageWorkPlanAnnotationVO: {
            code?: string;
            success?: boolean;
            data?: components["schemas"]["PageWorkPlanAnnotationVO"];
            message?: string;
            tid?: string;
        };
        TaskViewConfigDTO: {
        ...
        ServiceResultTaskViewConfigVO: {
            code?: string;
            success?: boolean;
            data?: components["schemas"]["TaskViewConfigVO"];
            message?: string;
            tid?: string;
        };
        ...
        MonthlyReportVO: {
            ...
            staffInfo?: components["schemas"]["StaffBaseInfo"];
            /** @description 月考勤概况 */
            generalSituation?: components["schemas"]["MonthlyGeneralSituation"];
            /** @description 异常统计 */
            abnormalStatistics?: components["schemas"]["AttendanceAbnormalStatistics"];
            /** @description 加班统计 */
            overtimeStatistics?: components["schemas"]["OvertimeStatistics"];
        ...
        ServiceResultPageOrgEnterpriseSubject: {
            code?: string;
            success?: boolean;
            data?: components["schemas"]["PageOrgEnterpriseSubject"];
            message?: string;
            tid?: string;
        };
        ...
        ServiceResultPageCompanySyncRecord: {
            code?: string;
            success?: boolean;
            data?: components["schemas"]["PageCompanySyncRecord"];
            message?: string;
            tid?: string;
        };
        StaffCreateRO: {
        ...
        ServiceResultPageDocDir: {
            ...
            success?: boolean;
            /** @description 主数据 */
            data?: components["schemas"]["PageDocDir"];
            /** @description 业务状态消息 */
            message?: string;
            /** @description trace id */
            tid?: string;
        ...
        ServiceResultPageStaffSelectionResult: {
            code?: string;
            success?: boolean;
            data?: components["schemas"]["PageStaffSelectionResult"];
            message?: string;
            tid?: string;
        };
        ...
        ServiceResultWxMaGetPhoneNumberVO: {
            code?: string;
            success?: boolean;
            data?: components["schemas"]["WxMaGetPhoneNumberVO"];
            message?: string;
            tid?: string;
        };
        ...
        PageMonthlyReportVO: {
            records?: components["schemas"]["MonthlyReportVO"][];
            /** Format: int64 */
            total?: number;
            /** Format: int64 */
            size?: number;
        ...
        ServiceResultOrgEnterpriseSubject: {
            code?: string;
            success?: boolean;
            data?: components["schemas"]["OrgEnterpriseSubject"];
            message?: string;
            tid?: string;
        };
        OvertimeRuleSaveROCreate: {
            ...
            effectiveTimeRule?: number;
            /** @description 加班计算规则 */
            calculationRule?: components["schemas"]["OvertimeCalculateRuleCreate"];
            /** @description 加班核算规则 */
        ...
        PageAppraiseItemVO: {
            records?: components["schemas"]["AppraiseItemVO"][];
            /** Format: int64 */
            total?: number;
            /** Format: int64 */
            size?: number;
        ...
        ShiftTimePeriodROCreate: {
            ...
            /** @description 休息时段 */
            breakTimePeriods?: components["schemas"]["BreakTimePeriodROCreate"][];
        };
        SysDictDataROCreate: {
            /**
             * Format: int64
        ...
        ServiceResultPageMonthlyReportVO: {
            code?: string;
            success?: boolean;
            data?: components["schemas"]["PageMonthlyReportVO"];
            message?: string;
            tid?: string;
        };
        BngCompanyEdit: {
            ...
            /** Format: int64 */
            registerSoftId?: number;
            bngVersionPackage?: components["schemas"]["BngVersionPackageEdit"][];
            logs?: components["schemas"]["OrderLogEdit"][];
            /** Format: int64 */
            versionId?: number;
            /** Format: int64 */
            softId?: number;
        ...
        StaffFieldConfigSaveROModify: {
            ...
            options?: components["schemas"]["OptionItemModify"][];
            /** @description 字段配置表 */
            configItems?: components["schemas"]["CustomFieldConfigModify"][];
        };
        ServiceResultPageAppraiseItemVO: {
            code?: string;
            success?: boolean;
            data?: components["schemas"]["PageAppraiseItemVO"];
            message?: string;
            tid?: string;
        };
        ...
        ShiftTimePeriodSeasonCreate: {
            ...
            timePeriods?: components["schemas"]["ShiftTimePeriodROCreate"][];
        };
        ...
        LoginCacheEdit: {
            ...
            userId?: number;
            token?: string;
            bngUser?: components["schemas"]["BngUserEdit"];
            lastLoginTime?: string;
            companyList?: components["schemas"]["BngCompanyEdit"][];
            currentBngCompany?: components["schemas"]["BngCompanyEdit"];
            /** Format: int64 */
            currentSoftId?: number;
            /** Format: int64 */
            currentSoftVersionId?: number;
        ...
        PageOrgEnterpriseWorkplace: {
            records?: components["schemas"]["OrgEnterpriseWorkplace"][];
            /** Format: int64 */
            total?: number;
            /** Format: int64 */
            size?: number;
        ...
        ServiceResultAppraiseItemVO: {
            code?: string;
            success?: boolean;
            data?: components["schemas"]["AppraiseItemVO"];
            message?: string;
            tid?: string;
        };
        ...
        SelectionConditionQuery: {
            ...
            operator?: 1 | 2 | 3 | 4 | 5;
            /** @description 维度数据 */
            data?: components["schemas"]["StaffDimensionDataQuery"][];
        };
        ...
        ServiceResultPageOrgEnterpriseWorkplace: {
            ...
            success?: boolean;
            /** @description 主数据 */
            data?: components["schemas"]["PageOrgEnterpriseWorkplace"];
            /** @description 业务状态消息 */
            message?: string;
            /** @description trace id */
            tid?: string;
        ...
        HrAttendanceGroupDetailVO: {
            ...
            lastVersion?: number;
            /** @description 工作日设置 */
            workdaySetting?: components["schemas"]["WorkdayShiftSetting"][];
            /** @description 适用班次 */
            shiftNos?: number[];
            /** @description 排班制排班扩展设置 */
            shiftScheduleSetting?: components["schemas"]["ShiftScheduleSetting"];
            /**
            ...
            /** @description 休息日打卡设置 */
            dayOffClockSetting?: components["schemas"]["DayOffClockSetting"];
            /** @description 必须打卡的日期设置 */
            mustClockSettings?: components["schemas"]["SpecialClockDateSetting"][];
            /** @description 无需打卡的日期设置 */
            undesiredClockSettings?: components["schemas"]["SpecialClockDateSetting"][];
            /** @description 打卡方式设置 */
            clockWaySetting?: components["schemas"]["ClockWaySetting"];
            /**
             * Format: int64
             * @description 补卡设置
             */
            ...
            /** @description 请假打卡设置 */
            leaveClockSetting?: components["schemas"]["LeaveClockSetting"];
            /** @description 外勤打卡设置 */
            outworkClockSetting?: components["schemas"]["OutworkClockSetting"];
            /** @description 加班规则设置 */
            overtimeRuleSetting?: components["schemas"]["OvertimeRuleSetting"];
            /** @description 考勤月度周期设置 */
            monthCycleSetting?: components["schemas"]["MonthCycleSetting"];
            /** @description 拍照/人脸识别设置 */
            verificationRule?: components["schemas"]["VerificationRule"];
            /** @description 范围外打卡设置 */
            outOfScopeClockSetting?: components["schemas"]["OutOfScopeClockSetting"];
            selectionForm?: components["schemas"]["StaffSelectionConditionData"];
        };
        ...
        StaffSelectionBoundQueryROQuery: {
            ...
            order?: components["schemas"]["OrderConditionQuery"][];
            /** @description 条件列表 */
            conditions?: components["schemas"]["SelectionConditionQuery"][];
        };
        PageDocNoticeD: {
            records?: components["schemas"]["DocNoticeD"][];
            /** Format: int64 */
            total?: number;
            /** Format: int64 */
            size?: number;
        ...
        WorkPlanListDetailVO: {
            ...
            /** @description 子集 */
            children?: components["schemas"]["WorkPlanListDetailVO"][];
            /** @description 附件 */
            attachmentList?: components["schemas"]["WorkPlanAttachmentVO"][];
            /** @description 执行人 */
            executorList?: components["schemas"]["WorkPlanExecutorVO"][];
        ...
        HalfDayWorkTimeSettingCreate: {
            /** @description 上午时段 */
            am?: components["schemas"]["TimePeriodCreate"];
            /** @description 下午时段 */
            pm?: components["schemas"]["TimePeriodCreate"];
        };
        ShiftTimePeriodClockDetailInfo: {
            /** @description 上班卡 */
            clockIn?: components["schemas"]["ClockDetailData"];
            /** @description 下班卡 */
            clockOut?: components["schemas"]["ClockDetailData"];
        };
        TieredTimeEdit: {
            /** @description 工作分钟数 */
            workMinutes?: number;
        ...
        ServiceResultOrgEnterpriseWorkplace: {
            ...
            success?: boolean;
            /** @description 主数据 */
            data?: components["schemas"]["OrgEnterpriseWorkplace"];
            /** @description 业务状态消息 */
            message?: string;
            /** @description trace id */
            tid?: string;
        ...
        ServiceResultHrAttendanceGroupDetailVO: {
            ...
            success?: boolean;
            /** @description 主数据 */
            data?: components["schemas"]["HrAttendanceGroupDetailVO"];
            /** @description 业务状态消息 */
            message?: string;
            /** @description trace id */
            tid?: string;
        ...
        ServiceResultDocDir: {
            ...
            success?: boolean;
            /** @description 主数据 */
            data?: components["schemas"]["DocDir"];
            /** @description 业务状态消息 */
            message?: string;
            /** @description trace id */
            tid?: string;
        ...
        AdminStaffSingleFieldUpdateROModify: {
            ...
            id: number;
            /** @description 字段值 */
            fieldValue: components["schemas"]["FieldValueModify"];
        };
        ...
        ServiceResultPageDocNoticeD: {
            ...
            success?: boolean;
            /** @description 主数据 */
            data?: components["schemas"]["PageDocNoticeD"];
            /** @description 业务状态消息 */
            message?: string;
            /** @description trace id */
            tid?: string;
        ...
        WorkPlanListVO: {
            ...
            userPosition?: string;
            /** @description 工作计划 */
            workPlanList?: components["schemas"]["WorkPlanListDetailVO"][];
        };
        ...
        ShiftClockDetailInfo: {
            ...
            timePeriodClockDetails?: components["schemas"]["ShiftTimePeriodClockDetailInfo"][];
        };
        OvertimeCalculateRuleEdit: {
            ...
            deductType?: never;
            /** @description 休息时段 */
            breakTimePeriods?: components["schemas"]["TimePeriodEdit"][];
            /** @description 时长扣除规则 */
            deductRules?: components["schemas"]["TieredTimeEdit"][];
            /**
             * @description 下班后多久开始计算加班（单位：分钟）
             * @default 0
             */
        ...
        DocDirAddShareTargetDTO: {
            ...
            id?: number;
            from?: string;
            targets: components["schemas"]["Item"][];
        };
        ...
        ServiceResultListWorkPlanListVO: {
            code?: string;
            success?: boolean;
            data?: components["schemas"]["WorkPlanListVO"][];
            message?: string;
            tid?: string;
        };
        StaffOrderRO: {
        ...
        FlexibleClockSettingCreate: {
            ...
            flexibleTimeSetting?: components["schemas"]["FlexibleTimeSettingCreate"];
            /** @description 是否开启下班晚走，次日晚到 */
            leaveLateArriveLateEnabled?: boolean;
            /** @description 下班晚走次日晚到时间设置 */
            leaveLateArriveLateTimeSetting?: components["schemas"]["FlexibleTimeSettingCreate"][];
        ...
        PageOrgEnterpriseCostCenter: {
            records?: components["schemas"]["OrgEnterpriseCostCenter"][];
            /** Format: int64 */
            total?: number;
            /** Format: int64 */
            size?: number;
        ...
        ShiftSaveROCreate: {
            ...
            timePeriodSeasons: components["schemas"]["ShiftTimePeriodSeasonCreate"][];
            ...
            halfDayWorkTimeSetting: components["schemas"]["HalfDayWorkTimeSettingCreate"];
            /** @description 班次颜色 */
            color?: string;
            /** @description 是否区分令时 */
            ...
            winterMonth?: number[];
            /** @description 弹性打卡设置 */
            flexibleClockSetting: components["schemas"]["FlexibleClockSettingCreate"];
        };
        BatchReplaceRO: {
            /**
             * Format: int64
        ...
        ClockDetailReportVO: {
            ...
            staffInfo?: components["schemas"]["StaffBaseInfo"];
            /** @description 班次打卡明细 */
            shiftClockDetail?: components["schemas"]["ShiftClockDetailInfo"];
            /** @description 打卡流水 */
            clockLogs?: components["schemas"]["ClockLogDetail"][];
        };
        ...
        ServiceResultPageOrgEnterpriseCostCenter: {
            code?: string;
            success?: boolean;
            data?: components["schemas"]["PageOrgEnterpriseCostCenter"];
            message?: string;
            tid?: string;
        };
        DocDirFullEditDTO: {
        ...
        ServiceResultListAppraiseTableVO: {
            code?: string;
            success?: boolean;
            data?: components["schemas"]["AppraiseTableVO"][];
            message?: string;
            tid?: string;
        };
        AppraiseStatusCountVO: {
            ...
            unit?: string;
            /** @description 人员明细列表 */
            staffDetails?: components["schemas"]["AppraiseStaffDetailVO"][];
        };
        DocNoticeResignDTO: {
            /** Format: int64 */
            id?: number;
        ...
        PageClockDetailReportVO: {
            records?: components["schemas"]["ClockDetailReportVO"][];
            /** Format: int64 */
            total?: number;
            /** Format: int64 */
            size?: number;
        ...
        OvertimeRuleSaveROEdit: {
            ...
            /** @description 加班计算规则 */
            calculationRule?: components["schemas"]["OvertimeCalculateRuleEdit"];
            /** @description 加班核算规则 */
            accountingRule?: components["schemas"]["OvertimeAccountingRuleEdit"];
            /** @description 加班时长规则 */
            durationRule?: components["schemas"]["OvertimeDurationEdit"];
            /**
        ...
        ServiceResultOrgEnterpriseCostCenter: {
            code?: string;
            success?: boolean;
            data?: components["schemas"]["OrgEnterpriseCostCenter"];
            message?: string;
            tid?: string;
        };
        AppraiseStaffOverviewBaseVO: {
            ...
            statusCounts?: components["schemas"]["AppraiseStatusCountVO"][];
        };
        WorkOrderClassifyVO: {
            /** @description 主键ID */
            id?: string;
        ...
        ServiceResultPageClockDetailReportVO: {
            code?: string;
            success?: boolean;
            data?: components["schemas"]["PageClockDetailReportVO"];
            message?: string;
            tid?: string;
        };
        BngUserModify: {
        ...
        ServiceResultAppraiseStaffOverviewBaseVO: {
            code?: string;
            success?: boolean;
            data?: components["schemas"]["AppraiseStaffOverviewBaseVO"];
            message?: string;
            tid?: string;
        };
        ...
        ServiceResultListWorkOrderClassifyVO: {
            code?: string;
            success?: boolean;
            data?: components["schemas"]["WorkOrderClassifyVO"][];
            message?: string;
            tid?: string;
        };
        HrStaffGroupChangeVO: {
            ...
            staffList?: components["schemas"]["StaffInfoVO"][];
        };
        BngVersionPackageModify: {
            ...
            softName?: string;
            domain?: string;
            adminUser?: components["schemas"]["BngUserModify"][];
        };
        keyModify: {
            /** @description 配置项（"SHOW": 可展示性; "EDITABLE": 可编辑性; "REQUIRED": 必填性） */
            item?: string;
        ...
        PageWorkOrderClassifyVO: {
             ...
             * @default Collections.emptyList()
             */
            records: components["schemas"]["WorkOrderClassifyVO"][];
            /**
             * Format: int64
             * @description 总数
             * @default 0
        ...
        AttGroupPreCheckResultVO: {
            /** @description 考勤组冲突数据 */
            groupChangeList?: components["schemas"]["HrStaffGroupChangeVO"][];
            /** @description 移出当前考勤组的员工列表 */
            unblockStaffs?: components["schemas"]["StaffInfoVO"][];
        };
        OrderLogModify: {
            /**
             * Format: int64
        ...
        MapListCustomFieldConfigItemModify: {
            key?: components["schemas"]["keyModify"][];
        };
        ServiceResultAppraiseStaffOverviewVO: {
            code?: string;
            success?: boolean;
            data?: components["schemas"]["AppraiseStaffOverviewVO"];
            message?: string;
            tid?: string;
        };
        ...
        WorkOrderClassifySimpleVO: {
            ...
            totalNum?: number;
            /** @description 类型 */
            classifyList?: components["schemas"]["WorkOrderClassifySimpleDetailVO"][];
        };
        ServiceResultPageWorkOrderClassifyVO: {
            code?: string;
            success?: boolean;
            data?: components["schemas"]["PageWorkOrderClassifyVO"];
            message?: string;
            tid?: string;
        };
        ServiceResultListCurrentDeptStaffDetailVO: {
            ...
            success?: boolean;
            /** @description 主数据 */
            data?: components["schemas"]["CurrentDeptStaffDetailVO"][];
            /** @description 业务状态消息 */
            message?: string;
            /** @description trace id */
            tid?: string;
        ...
        ServiceResultAttGroupPreCheckResultVO: {
            ...
            success?: boolean;
            /** @description 主数据 */
            data?: components["schemas"]["AttGroupPreCheckResultVO"];
            /** @description 业务状态消息 */
            message?: string;
            /** @description trace id */
            tid?: string;
        ...
        ServiceResultWorkOrderClassifySimpleVO: {
            code?: string;
            success?: boolean;
            data?: components["schemas"]["WorkOrderClassifySimpleVO"];
            message?: string;
            tid?: string;
        };
        ...
        CurrentDeptDetailVO: {
            ...
            expandFlag?: boolean;
            /** @description 子集部门 */
            children?: components["schemas"]["CurrentDeptDetailVO"][];
            /** @description 员工数据 */
            staffList?: components["schemas"]["CurrentDeptStaffDetailVO"][];
        };
        BngCompanyModify: {
            /**
             * Format: int64
            ...
            /** Format: int64 */
            registerSoftId?: number;
            bngVersionPackage?: components["schemas"]["BngVersionPackageModify"][];
            logs?: components["schemas"]["OrderLogModify"][];
            /** Format: int64 */
            versionId?: number;
            /** Format: int64 */
            softId?: number;
        ...
        AttStaffDimensionDataEdit: {
            ...
            dimensionDataList?: components["schemas"]["AttDimensionDataEdit"][];
        };
        ...
        WorkOrderClassifyStatisticsVO: {
            ...
            total?: number;
            /** @description 状态统计 */
            detailList?: components["schemas"]["WorkOrderClassifyStatisticsDetailVO"][];
        };
        ...
        ServiceResultGetCurrentDeptStaffVO: {
            ...
            success?: boolean;
            /** @description 主数据 */
            data?: components["schemas"]["GetCurrentDeptStaffVO"];
            /** @description 业务状态消息 */
            message?: string;
            /** @description trace id */
            tid?: string;
        ...
        LoginCacheModify: {
            ...
            userId?: number;
            token?: string;
            bngUser?: components["schemas"]["BngUserModify"];
            lastLoginTime?: string;
            companyList?: components["schemas"]["BngCompanyModify"][];
            currentBngCompany?: components["schemas"]["BngCompanyModify"];
            /** Format: int64 */
            currentSoftId?: number;
            /** Format: int64 */
            currentSoftVersionId?: number;
        ...
        HrAttendanceGroupValidateROCreate: {
            ...
            staffNos?: number[];
            /** @description 员工选择条件 */
            selectionConditionData: components["schemas"]["StaffSelectionConditionDataCreate"];
        };
        CustomFieldConfigModify: {
            /** @description 业务端点（STAFF_DETAIL: 员工端员工档案, STAFF_ENTRY_REGISTRATION: 员工端入职登记表, ADMIN_ADD_STAFF: 管理端添加人员） */
            point: string;
            configs: components["schemas"]["FieldItemConfigModify"][];
        };
        ServiceResultListAppraiseDeptConfigVO: {
            code?: string;
            success?: boolean;
            data?: components["schemas"]["AppraiseDeptConfigVO"][];
            message?: string;
            tid?: string;
        };
        ServiceResultListAppraiseConfigForcedRule: {
            code?: string;
            success?: boolean;
            data?: components["schemas"]["AppraiseConfigForcedRule"][];
            message?: string;
            tid?: string;
        };
        FieldTemplateSaveROCreate: {
            /** @description 字段及排序 */
            fieldOrder: components["schemas"]["FieldOrderCreate"][];
        };
        PageWorkOrderVO: {
            /**
             * @description 查询数据列表
             * @default Collections.emptyList()
             */
            records: components["schemas"]["WorkOrderVO"][];
            /**
             * Format: int64
             * @description 总数
             * @default 0
        ...
        ServiceResultListWorkOrderClassifyStatisticsVO: {
            ...
            success?: boolean;
            /** @description 主数据 */
            data?: components["schemas"]["WorkOrderClassifyStatisticsVO"][];
            /** @description 业务状态消息 */
            message?: string;
            /** @description trace id */
            tid?: string;
        ...
        GetCurrentDeptStaffVO: {
            ...
            companyName?: string;
            /** @description 组织架构树 */
            deptTree?: components["schemas"]["CurrentDeptDetailVO"][];
        };
        ServiceResultPageWorkOrderVO: {
            code?: string;
            success?: boolean;
            data?: components["schemas"]["PageWorkOrderVO"];
            message?: string;
            tid?: string;
        };
        ...
        AppraiseDeptSummaryVO: {
            ...
            coverage?: number;
            appraiseDeptConfigVOList?: components["schemas"]["AppraiseDeptConfigVO"][];
        };
        AppraiseStaffProject: {
            ...
            postTableConfigList?: components["schemas"]["AppraisePostTableConfig"][];
        };
        ...
        OvertimeCalculateRuleModify: {
            ...
            deductType?: number;
            /** @description 休息时段 */
            breakTimePeriods?: components["schemas"]["TimePeriodModify"][];
            /** @description 时长扣除规则 */
            deductRules?: components["schemas"]["TieredTimeModify"][];
            /**
             * @description 下班后多久开始计算加班（单位：分钟）
             * @default 0
             */
        ...
        ServiceResultAppraiseDeptConfig: {
            code?: string;
            success?: boolean;
            data?: components["schemas"]["AppraiseDeptConfig"];
            message?: string;
            tid?: string;
        };
        ServiceResultAppraiseDeptSummaryVO: {
            code?: string;
            success?: boolean;
            data?: components["schemas"]["AppraiseDeptSummaryVO"];
            message?: string;
            tid?: string;
        };
        ServiceResultListAppraiseStaffProject: {
            code?: string;
            success?: boolean;
            data?: components["schemas"]["AppraiseStaffProject"][];
            message?: string;
            tid?: string;
        };
        WorkOrderCreateDTO: {
            ...
            /** @description 附件 */
            attachments?: components["schemas"]["WorkOrderAttachmentDTO"][];
        };
        WorkOrderRecordsVO: {
            /** @description 内容 */
        ...
        WorkOrderDetailVO: {
            ...
            createTime?: string;
            /** @description 工单操作记录 */
            recordList?: components["schemas"]["WorkOrderRecordsVO"][];
            /** @description 附件 */
            attachments?: components["schemas"]["WorkOrderAttachmentVO"][];
            /** @description 流程进度 */
            processProgress?: components["schemas"]["WorkOrderProcessProgressVO"][];
        };
        ...
        GetCurrentStaffAllDataPermissionVO: {
            ...
            /** @description 拥有的数据权限 */
            dataPermission?: components["schemas"]["MapDatePermissionRelationDetailVO"];
        };
        ...
        ServiceResultWorkOrderDetailVO: {
            code?: string;
            success?: boolean;
            data?: components["schemas"]["WorkOrderDetailVO"];
            message?: string;
            tid?: string;
        };
        ServiceResultGetCurrentStaffAllDataPermissionVO: {
            ...
            success?: boolean;
            /** @description 主数据 */
            data?: components["schemas"]["GetCurrentStaffAllDataPermissionVO"];
            /** @description 业务状态消息 */
            message?: string;
            /** @description trace id */
            tid?: string;
        ...
        OvertimeRuleSaveROModify: {
            ...
            effectiveTimeRule?: number;
            /** @description 加班计算规则 */
            calculationRule?: components["schemas"]["OvertimeCalculateRuleModify"];
            /** @description 加班核算规则 */
        ...
        GetAllStaffByDataPermissionVO: {
            ...
            modelList?: number[];
            /** @description 员工信息 */
            staffList?: components["schemas"]["HrmStaffBaseInfo"][];
        };
        ...
        ServiceResultGetAllStaffByDataPermissionVO: {
            ...
            success?: boolean;
            /** @description 主数据 */
            data?: components["schemas"]["GetAllStaffByDataPermissionVO"];
            /** @description 业务状态消息 */
            message?: string;
            /** @description trace id */
            tid?: string;
        ...
        ServiceResultWorkOrderStatisticsVO: {
            code?: string;
            success?: boolean;
            data?: components["schemas"]["WorkOrderStatisticsVO"];
            message?: string;
            tid?: string;
        };
        DocNoticeTimeoutUnSignVO: {
            ...
            cntList?: components["schemas"]["DocNoticeTypeCntVO"][];
            /** @description 未签阅的公文简化信息 集合 */
            notices?: components["schemas"]["DocNoticeMini"][];
        };
        ReissueClockRuleVO: {
            /** Format: int64 */
            id?: number;
        ...
        AppraiseStaffTableDetailVO: {
            ...
            needSync?: number;
            /** @description ORK */
            okrList?: components["schemas"]["AppriasePostTableItemVO"][];
            /** @description 自评分 */
            selfScore?: number;
            /** @description 360评分 */
            cycleScore?: number;
        ...
        PageMeetingVO: {
             ...
             * @default Collections.emptyList()
             */
            records: components["schemas"]["MeetingVO"][];
            /**
             * Format: int64
             * @description 总数
             * @default 0
        ...
        ServiceResultDocNoticeTimeoutUnSignVO: {
            ...
            success?: boolean;
            /** @description 主数据 */
            data?: components["schemas"]["DocNoticeTimeoutUnSignVO"];
            /** @description 业务状态消息 */
            message?: string;
            /** @description trace id */
            tid?: string;
        ...
        PageReissueClockRuleVO: {
            records?: components["schemas"]["ReissueClockRuleVO"][];
            /** Format: int64 */
            total?: number;
            /** Format: int64 */
            size?: number;
        ...
        ServiceResultAppraiseStaffTableDetailVO: {
            code?: string;
            success?: boolean;
            data?: components["schemas"]["AppraiseStaffTableDetailVO"];
            message?: string;
            tid?: string;
        };
        ServiceResultPageMeetingVO: {
            code?: string;
            success?: boolean;
            data?: components["schemas"]["PageMeetingVO"];
            message?: string;
            tid?: string;
        };
        ...
        ServiceResultPageReissueClockRuleVO: {
            ...
            success?: boolean;
            /** @description 主数据 */
            data?: components["schemas"]["PageReissueClockRuleVO"];
            /** @description 业务状态消息 */
            message?: string;
            /** @description trace id */
            tid?: string;
        ...
        AppraiseStaffConfirmDTO: {
            ...
            orkItemList?: components["schemas"]["AppraiseStaffConfirmOKRDTO"][];
            /** @description 考核 Item */
            checkItemList?: components["schemas"]["AppraiseStaffConfirmCheckDTO"][];
        };
        MeetingDTO: {
            /**
             * @description 页码
        ...
        ServiceResultWorkOrderStatisticsByStatusVO: {
            ...
            success?: boolean;
            /** @description 主数据 */
            data?: components["schemas"]["WorkOrderStatisticsByStatusVO"];
            /** @description 业务状态消息 */
            message?: string;
            /** @description trace id */
            tid?: string;
        ...
        StaffSelectionConditionEdit: {
            ...
            operator?: 1 | 2;
            /** @description 维度数据 */
            data?: components["schemas"]["StaffDimensionDataEdit"][];
        };
        HrAttendanceGroupSaveROCreate: {
            ...
            workdaySetting?: components["schemas"]["WorkdayShiftSettingCreate"][];
            /** @description 适用班次（排班制必填） */
            shiftNos?: number[];
            /** @description 排班制排班扩展设置 */
            shiftScheduleSetting?: components["schemas"]["ShiftScheduleSettingCreate"];
            /**
             * @description 法定节假日是否排休
             * @default false
             */
            restOnHolidays: boolean;
            /** @description 休息日打卡设置 */
            dayOffClockSetting?: components["schemas"]["DayOffClockSettingCreate"];
            /** @description 必须打卡的日期设置 */
            mustClockSettings?: components["schemas"]["SpecialClockDateSettingCreate"][];
            /** @description 无需打卡的日期设置 */
            undesiredClockSettings?: components["schemas"]["SpecialClockDateSettingCreate"][];
            /** @description 打卡方式设置 */
            clockWaySetting?: components["schemas"]["ClockWaySettingCreate"];
            /**
             * Format: int64
             * @description 补卡设置
             */
            reissueClockRuleId?: number;
            /** @description 请假打卡设置 */
            leaveClockSetting?: components["schemas"]["LeaveClockSettingCreate"];
            /** @description 外勤打卡设置 */
            outworkClockSetting?: components["schemas"]["OutworkClockSettingCreate"];
            /** @description 加班规则设置 */
            overtimeRuleSetting?: components["schemas"]["OvertimeRuleSettingCreate"];
            /** @description 拍照/人脸识别设置 */
            verificationRule?: components["schemas"]["VerificationRuleCreate"];
            /** @description 范围外打卡设置 */
            outOfScopeClockSetting?: components["schemas"]["OutOfScopeClockSettingCreate"];
            /**
            ...
            /** @description 员工选择条件 */
            selectionForm: components["schemas"]["StaffSelectionConditionDataCreate"];
        };
        MeetingAttachmentVO: {
            /** @description 主键ID */
            id?: string;
        ...
        ServiceResultReissueClockRuleVO: {
            ...
            success?: boolean;
            /** @description 主数据 */
            data?: components["schemas"]["ReissueClockRuleVO"];
            /** @description 业务状态消息 */
            message?: string;
            /** @description trace id */
            tid?: string;
        ...
        HrAttendanceGroupSaveROEdit: {
            ...
            groupType?: number;
            /** @description 工作日设置 */
            workdaySetting?: components["schemas"]["WorkdayShiftSettingEdit"][];
            /** @description 适用班次 */
            shiftNos?: number[];
            /** @description 排班制排班扩展设置 */
            shiftScheduleSetting?: components["schemas"]["ShiftScheduleSettingEdit"];
            /**
             * @description 法定节假日是否排休
             * @default false
             */
            restOnHolidays: boolean;
            /** @description 休息日打卡设置 */
            dayOffClockSetting?: components["schemas"]["DayOffClockSettingEdit"];
            /** @description 必须打卡的日期设置 */
            mustClockSettings?: components["schemas"]["SpecialClockDateSettingEdit"][];
            /** @description 无需打卡的日期设置 */
            undesiredClockSettings?: components["schemas"]["SpecialClockDateSettingEdit"][];
            /** @description 打卡方式设置 */
            clockWaySetting?: components["schemas"]["ClockWaySettingEdit"];
            /**
             * Format: int64
             * @description 补卡设置
             */
            reissueClockRuleId?: number;
            /** @description 请假打卡设置 */
            leaveClockSetting?: components["schemas"]["LeaveClockSettingEdit"];
            /** @description 外勤打卡设置 */
            outworkClockSetting?: components["schemas"]["OutworkClockSettingEdit"];
            /** @description 加班规则设置 */
            overtimeRuleSetting?: components["schemas"]["OvertimeRuleSettingEdit"];
            /** @description 考勤月度周期设置 */
            monthCycleSetting?: components["schemas"]["MonthCycleSettingEdit"];
            /** @description 拍照/人脸识别设置 */
            verificationRule?: components["schemas"]["VerificationRuleEdit"];
            /** @description 范围外打卡设置 */
            outOfScopeClockSetting?: components["schemas"]["OutOfScopeClockSettingEdit"];
            /** @description 员工选择条件 */
            staffSelectionRules: components["schemas"]["StaffSelectionConditionEdit"][];
        };
        StaffNameIdPicVO: {
            /**
             * Format: int64
        ...
        MeetingParticipantVO: {
            ...
            deptName?: string[];
            /** @description 人员信息 */
            participantList?: components["schemas"]["MeetingParticipantDetailVO"][];
        };
        ...
        AttStaffDimensionDataModify: {
            ...
            staffNo?: number;
            /** @description 员工关联维度与维度值 */
            dimensionDataList?: components["schemas"]["AttDimensionDataModify"][];
        };
        MeetingDetailVO: {
            /** @description 主键ID */
            id?: string;
            ...
            createTime?: string;
            /** @description 会议附件 */
            attachmentList?: components["schemas"]["MeetingAttachmentVO"][];
            /** @description 会议参会人 */
            participant?: components["schemas"]["MeetingParticipantVO"];
            /** @description 会议抄送人 */
            cc?: components["schemas"]["MeetingParticipantVO"];
            /** @description 会议纪要人 */
            summary?: components["schemas"]["MeetingParticipantVO"];
            /** @description 决议审批人 */
            resolutionApprover?: components["schemas"]["MeetingParticipantVO"];
            /** @description 会议相关决议 */
            resolutionList?: components["schemas"]["MeetingResolutionVO"][];
        };
        ClockErrorLogVO: {
            /** Format: int64 */
            id?: number;
        ...
        ServiceResultMeetingDetailVO: {
            code?: string;
            success?: boolean;
            data?: components["schemas"]["MeetingDetailVO"];
            message?: string;
            tid?: string;
        };
        ServiceResultListClockErrorLogVO: {
            code?: string;
            success?: boolean;
            data?: components["schemas"]["ClockErrorLogVO"][];
            message?: string;
            tid?: string;
        };
        ...
        ServiceResultListClockLogVO: {
            code?: string;
            success?: boolean;
            data?: components["schemas"]["ClockLogVO"][];
            message?: string;
            tid?: string;
        };
        ...
        MeetingCreateDTO: {
            ...
            /** @description 会议附件 */
            attachmentList?: components["schemas"]["MeetingAttachmentDTO"][];
        ...
        ShiftAccountVO: {
            ...
            /** @description 请假缺卡类型 */
            vacationMissClockInfo?: components["schemas"]["VacationMissClockInfo"][];
            /** @description 迟到分钟数 */
            lateMinutes?: number;
            /** @description 早退分钟数 */
            leaveEarlyMinutes?: number;
            ...
            latestClockTime?: string;
            /** @description 考勤时段明细 */
            timePeriods?: components["schemas"]["AttendanceTimePeriodVO"][];
        };
        ...
        AttendanceDayVO: {
            ...
            dailyShifts?: components["schemas"]["ShiftAccountVO"][];
        };
        RefIdDetail: {
            deptPositions?: components["schemas"]["DeptPositionItem"][];
        };
        WorkPlanGroupVO: {
            /** @description 主键ID */
            id?: string;
            ...
            workPlanList?: components["schemas"]["WorkPlanListDetailVO"][];
            /** @description 子集 */
            children?: components["schemas"]["WorkPlanGroupVO"][];
        };
        SelectionConditionModify: {
            ...
            operator?: 1 | 2 | 3 | 4 | 5;
            /** @description 维度数据 */
            data?: components["schemas"]["StaffDimensionDataModify"][];
        };
        StaffMonthCalendarVO: {
            ...
            overtimeHours?: number;
            /** @description 考勤日明细 */
            days?: components["schemas"]["AttendanceDayVO"][];
        };
        AppraiseTableVO1: {
            /** @description 考核表名字 */
            name?: string;
        ...
        WorkPlanListGroupVO: {
            ...
            userPosition?: string;
            /** @description 工作计划分组 */
            workPlanGroupList?: components["schemas"]["WorkPlanGroupVO"][];
        };
        StaffSelectionConditionDataModify: {
            /** Format: int64 */
            id?: number;
            /** @description 条件列表 */
            conditions?: components["schemas"]["SelectionConditionModify"][];
        };
        ServiceResultStaffMonthCalendarVO: {
            code?: string;
            success?: boolean;
            data?: components["schemas"]["StaffMonthCalendarVO"];
            message?: string;
            tid?: string;
        };
        DistributionDetail: {
            /** @description 键：等级标识（如"S"、"A"、"B"），值：百分比（如10表示10%） */
            gradeRatio?: components["schemas"]["MapBigDecimal"];
        };
        ServiceResultListWorkPlanListGroupVO: {
            code?: string;
            success?: boolean;
            data?: components["schemas"]["WorkPlanListGroupVO"][];
            message?: string;
            tid?: string;
        };
        TimeSlot: {
        ...
        HrAttendanceGroupSaveROModify: {
            ...
            firstBiWeeklyDayOff?: string;
            /** @description 工作日设置（固定班制必填） */
            workdaySetting?: components["schemas"]["WorkdayShiftSettingModify"][];
            /** @description 适用班次（排班制必填） */
            shiftNos?: number[];
            /** @description 排班制排班扩展设置 */
            shiftScheduleSetting?: components["schemas"]["ShiftScheduleSettingModify"];
            /**
             * @description 法定节假日是否排休
             * @default false
             */
            restOnHolidays: boolean;
            /** @description 休息日打卡设置 */
            dayOffClockSetting?: components["schemas"]["DayOffClockSettingModify"];
            /** @description 必须打卡的日期设置 */
            mustClockSettings?: components["schemas"]["SpecialClockDateSettingModify"][];
            /** @description 无需打卡的日期设置 */
            undesiredClockSettings?: components["schemas"]["SpecialClockDateSettingModify"][];
            /** @description 打卡方式设置 */
            clockWaySetting?: components["schemas"]["ClockWaySettingModify"];
            /**
             * Format: int64
             * @description 补卡设置
             */
            reissueClockRuleId?: number;
            /** @description 请假打卡设置 */
            leaveClockSetting?: components["schemas"]["LeaveClockSettingModify"];
            /** @description 外勤打卡设置 */
            outworkClockSetting?: components["schemas"]["OutworkClockSettingModify"];
            /** @description 加班规则设置 */
            overtimeRuleSetting?: components["schemas"]["OvertimeRuleSettingModify"];
            /** @description 拍照/人脸识别设置 */
            verificationRule?: components["schemas"]["VerificationRuleModify"];
            /** @description 范围外打卡设置 */
            outOfScopeClockSetting?: components["schemas"]["OutOfScopeClockSettingModify"];
            /**
             * @description 规则生效日期（默认明日生效）
             * @default LocalDate.now().plusDays(1)
             */
            ...
            conflictStrategy?: never;
            /** @description 员工选择条件 */
            selectionForm: components["schemas"]["StaffSelectionConditionDataModify"];
        };
        ...
        ShiftClockInfoVO: {
            ...
            timePeriods?: components["schemas"]["RealTimePeriodClockInfoVO"][];
        };
        ...
        RealTimeClockInfoVO: {
            ...
            clockDetails?: components["schemas"]["TimeSlot"][];
            /** @description 班次打卡信息 */
            shiftClockInfo?: components["schemas"]["ShiftClockInfoVO"];
        };
        AttEditROModify: {
            /**
             * Format: int64
        ...
        ServiceResultListMeetingCalendarStatusVO: {
            code?: string;
            success?: boolean;
            data?: components["schemas"]["MeetingCalendarStatusVO"][];
            message?: string;
            tid?: string;
        };
        ServiceResultRealTimeClockInfoVO: {
            code?: string;
            success?: boolean;
            data?: components["schemas"]["RealTimeClockInfoVO"];
            message?: string;
            tid?: string;
        };
        ...
        PageWorkPlanListDetailVO: {
             ...
             * @default Collections.emptyList()
             */
            records: components["schemas"]["WorkPlanListDetailVO"][];
            /**
             * Format: int64
             * @description 总数
             * @default 0
        ...
        ServiceResultPageWorkPlanListDetailVO: {
            ...
            success?: boolean;
            /** @description 主数据 */
            data?: components["schemas"]["PageWorkPlanListDetailVO"];
            /** @description 业务状态消息 */
            message?: string;
            /** @description trace id */
            tid?: string;
        ...
        Dimension: {
            ...
            /** @description 变更前的维度值 */
            oldDimensionValues?: components["schemas"]["DimensionValue"][];
            /** @description 变更后的维度值 */
            newDimensionValues?: components["schemas"]["DimensionValue"][];
        };
        WorkPlanDeleteDTO: {
            /** @description 工作计划ID */
            id?: string;
        ...
        StaffGroupChangeVO: {
            ...
            groupName?: string;
            /** @description 涉及变更的维度 */
            changeDimensions?: components["schemas"]["Dimension"][];
            /** @description 涉及变更的员工列表 */
            staffList?: components["schemas"]["StaffInfoVO"][];
        };
        StaffFollowDTO: {
        ...
        GroupPreSaveVO: {
            /** @description 考勤组冲突数据 */
            groupChangeList?: components["schemas"]["StaffGroupChangeVO"][];
            /** @description 移出当前考勤组的员工列表 */
            unblockStaffs?: components["schemas"]["StaffInfoVO"][];
        };
        ...
        ServiceResultGroupPreSaveVO: {
            code?: string;
            success?: boolean;
            data?: components["schemas"]["GroupPreSaveVO"];
            message?: string;
            tid?: string;
        };
        ...
        ServiceResultWorkPlanListDetailVO: {
            ...
            success?: boolean;
            /** @description 主数据 */
            data?: components["schemas"]["WorkPlanListDetailVO"];
            /** @description 业务状态消息 */
            message?: string;
            /** @description trace id */
            tid?: string;
        ...
        AppraiseForceDeptVO: {
            versionId?: number;
            deptVOList?: components["schemas"]["AppraiseDeptVO"][];
        };
        ServiceResultAppraiseForceDeptVO: {
            code?: string;
            success?: boolean;
            data?: components["schemas"]["AppraiseForceDeptVO"];
            message?: string;
            tid?: string;
        };
        WorkPlanFollowDTO: {
        ...
        ServiceResultListMeetingStatisticsVO: {
            ...
            success?: boolean;
            /** @description 主数据 */
            data?: components["schemas"]["MeetingStatisticsVO"][];
            /** @description 业务状态消息 */
            message?: string;
            /** @description trace id */
            tid?: string;
        ...
        GroupWorkDayShift: {
            ...
            dayOfWeek?: number;
            /** @description 班次概要 */
            shift?: components["schemas"]["ShiftInfoVO"];
        };
        AttendanceGroupSummaryInfoVO: {
            ...
            groupType?: number;
            /** @description 工作日设置 */
            workDays?: components["schemas"]["GroupWorkDayShift"][];
            /** @description 关联员工数 */
            staffCount?: number;
        };
        PageAttendanceGroupSummaryInfoVO: {
            records?: components["schemas"]["AttendanceGroupSummaryInfoVO"][];
            /** Format: int64 */
            total?: number;
            /** Format: int64 */
            size?: number;
        ...
        ServiceResultPageAttendanceGroupSummaryInfoVO: {
            ...
            success?: boolean;
            /** @description 主数据 */
            data?: components["schemas"]["PageAttendanceGroupSummaryInfoVO"];
            /** @description 业务状态消息 */
            message?: string;
            /** @description trace id */
            tid?: string;
        ...
        ServiceResultListAppraiseStaffTargetListVO: {
            code?: string;
            success?: boolean;
            data?: components["schemas"]["AppraiseStaffTargetListVO"][];
            message?: string;
            tid?: string;
        };
        ...
        BngVersionPackageQuery: {
            ...
            domain?: string;
            /** @description 超管账号 */
            adminUser?: components["schemas"]["BngUserQuery"][];
        };
        ServiceResultAttendanceGroupDetailVO: {
            code?: string;
            success?: boolean;
            data?: components["schemas"]["AttendanceGroupDetailVO"];
            message?: string;
            tid?: string;
        };
        OrderLogQuery: {
        ...
        BngCompanyQuery: {
             ...
             */
            registerSoftId?: number;
            bngVersionPackage?: components["schemas"]["BngVersionPackageQuery"][];
            logs?: components["schemas"]["OrderLogQuery"][];
            /** Format: int64 */
            versionId?: number;
            /** Format: int64 */
            softId?: number;
        ...
        LoginCacheQuery: {
            ...
            userId?: number;
            token?: string;
            bngUser?: components["schemas"]["BngUserQuery"];
            lastLoginTime?: string;
            companyList?: components["schemas"]["BngCompanyQuery"][];
            currentBngCompany?: components["schemas"]["BngCompanyQuery"];
            /** Format: int64 */
            currentSoftId?: number;
            /** Format: int64 */
            currentSoftVersionId?: number;
        ...
        AttendanceGroupSaveROEdit: {
            ...
            /** Format: int64 */
            id?: number;
            currentUser?: components["schemas"]["LoginCacheEdit"];
            /** @description 考勤组名称 */
            name: string;
            /** @description 考勤组类型（0：免考勤；1：固定制；2：排班制；3：自由工时制） */
            groupType: number;
            /** @description 适用员工范围 */
            staffDimension: components["schemas"]["ScopeDimensionFormLineEdit"][];
            /** @description 工作日设置 */
            workdaySetting?: components["schemas"]["WorkdayShiftSettingEdit"][];
            /** @description 适用班次 */
            shiftNos?: number[];
        ...
        AttendanceGroupSaveROModify: {
            ...
            /** Format: int64 */
            id: number;
            currentUser?: components["schemas"]["LoginCacheModify"];
            /** @description 考勤组名称 */
            name: string;
            /** @description 考勤组类型（0：免考勤；1：固定制；2：排班制；3：自由工时制） */
            groupType: number;
            /** @description 适用员工范围 */
            staffDimension: components["schemas"]["ScopeDimensionFormLineModify"][];
            /** @description 工作日设置 */
            workdaySetting?: components["schemas"]["WorkdayShiftSettingModify"][];
            /** @description 适用班次 */
            shiftNos?: number[];
            ...
            overtimeRuleSetting?: components["schemas"]["OvertimeRuleSettingModify"];
            /** @description 考勤月度周期设置 */
            monthCycleSetting: components["schemas"]["MonthCycleSettingModify"];
            /** @description 拍照/人脸识别设置 */
            verificationRule?: components["schemas"]["VerificationRuleModify"];
            /** @description 范围外打卡设置 */
            outOfScopeClockSetting?: components["schemas"]["OutOfScopeClockSettingModify"];
        ...
        PageStaffInfoVO: {
            records?: components["schemas"]["StaffInfoVO"][];
            /** Format: int64 */
            total?: number;
            /** Format: int64 */
            size?: number;
        ...
        ServiceResultPageStaffInfoVO: {
            ...
            success?: boolean;
            /** @description 主数据 */
            data?: components["schemas"]["PageStaffInfoVO"];
            /** @description 业务状态消息 */
            message?: string;
            /** @description trace id */
            tid?: string;
        ...
        ClockVO: {
            ...
            /** @description 可选班次 */
            optionalShifts?: components["schemas"]["OptionalShift"][];
        };
        ServiceResultClockVO: {
            ...
            success?: boolean;
            /** @description 主数据 */
            data?: components["schemas"]["ClockVO"];
            /** @description 业务状态消息 */
            message?: string;
            /** @description trace id */
            tid?: string;
        ...
        HrmStaffBaseInfoEdit: {
            ...
            personalPhoto?: string;
            planRegularDate?: string;
            currentCompany?: components["schemas"]["BngCompanyEdit"];
            loginCache?: components["schemas"]["LoginCacheEdit"];
        };
        ClockROEdit: {
            /** Format: int64 */
            coNo?: number;
            /** @description 当前登录员工 */
            currentStaff?: components["schemas"]["HrmStaffBaseInfoEdit"];
            /** @description 纬度 */
            latitude?: number;
            /** @description 经度 */
            longitude?: number;
        ...
        PageShiftInfoVO: {
            records?: components["schemas"]["ShiftInfoVO"][];
            /** Format: int64 */
            total?: number;
            /** Format: int64 */
            size?: number;
        ...
        ServiceResultPageShiftInfoVO: {
            ...
            success?: boolean;
            /** @description 主数据 */
            data?: components["schemas"]["PageShiftInfoVO"];
            /** @description 业务状态消息 */
            message?: string;
            /** @description trace id */
            tid?: string;
        ...
        ShiftTimePeriodRO: {
            ...
            clockOutEndTime?: string;
            /** @description 休息时段 */
            breakTimePeriods?: components["schemas"]["BreakTimePeriodRO"][];
        };
        ShiftTimePeriodSeason: {
            /** @description 令时（0：不区分令时；1：夏令时；2：冬令时） */
            season?: number;
            /** @description 令时对应时段配置 */
            timePeriods?: components["schemas"]["ShiftTimePeriodRO"][];
        };
        HalfDayWorkTimeSetting: {
            /** @description 上午时段 */
            am?: components["schemas"]["TimePeriod"];
            /** @description 下午时段 */
            pm?: components["schemas"]["TimePeriod"];
        };
        FlexibleTimeSetting: {
            /**
             * @description <ul>
        ...
        FlexibleClockSetting: {
            ...
            flexibleMode: number;
            /** @description 弹性打卡模式 - 弹性时间设置 */
            flexibleTimeSetting?: components["schemas"]["FlexibleTimeSetting"];
            /** @description 是否开启下班晚走，次日晚到 */
            leaveLateArriveLateEnabled?: boolean;
            /** @description 下班晚走次日晚到时间设置 */
            leaveLateArriveLateTimeSetting?: components["schemas"]["FlexibleTimeSetting"][];
            /** @description 作用方式（1：作用于整个班次；2：作用于每个时段） */
            modeOfAction?: number;
        };
        ShiftVO: {
            ...
            name?: string;
            /** @description 班次时段令时配置 */
            timePeriodSeasons?: components["schemas"]["ShiftTimePeriodSeason"][];
            /** @description 班次工时（自由工时制不能为空） */
            workHours?: number;
            /** @description 班次工时对应出勤天数 */
            hoursToDay?: number;
            ...
            absentLateMinutes?: number;
            /** @description 半天工作时间设置 */
            halfDayWorkTimeSetting?: components["schemas"]["HalfDayWorkTimeSetting"];
            /** @description 班次颜色 */
            color?: string;
            ...
            winterMonth?: number[];
            /** @description 弹性打卡设置 */
            flexibleClockSetting?: components["schemas"]["FlexibleClockSetting"];
        };
        ServiceResultShiftVO: {
            ...
            success?: boolean;
            /** @description 主数据 */
            data?: components["schemas"]["ShiftVO"];
            /** @description 业务状态消息 */
            message?: string;
            /** @description trace id */
            tid?: string;
        ...
        ShiftTimePeriodROEdit: {
            ...
            clockOutEndTime?: string;
            /** @description 休息时段 */
            breakTimePeriods?: components["schemas"]["BreakTimePeriodROEdit"][];
        };
        ShiftTimePeriodSeasonEdit: {
            /** @description 令时（1：夏令时；2：冬令时，不区分令时时可为空） */
            season?: number;
            /** @description 令时对应时段配置 */
            timePeriods?: components["schemas"]["ShiftTimePeriodROEdit"][];
        };
        HalfDayWorkTimeSettingEdit: {
            /** @description 上午时段 */
            am?: components["schemas"]["TimePeriodEdit"];
            /** @description 下午时段 */
            pm?: components["schemas"]["TimePeriodEdit"];
        };
        ...
        FlexibleClockSettingEdit: {
            ...
            flexibleMode: number;
            /** @description 弹性打卡模式 - 弹性时间设置 */
            flexibleTimeSetting?: components["schemas"]["FlexibleTimeSettingEdit"];
            /** @description 是否开启下班晚走，次日晚到 */
            leaveLateArriveLateEnabled?: boolean;
            /** @description 下班晚走次日晚到时间设置 */
            leaveLateArriveLateTimeSetting?: components["schemas"]["FlexibleTimeSettingEdit"][];
            /** @description 作用方式（1：作用于整个班次；2：作用于每个时段） */
            modeOfAction?: number;
        };
        ShiftSaveROEdit: {
            ...
            name: string;
            /** @description 班次时段令时配置 */
            timePeriodSeasons: components["schemas"]["ShiftTimePeriodSeasonEdit"][];
            /** @description 班次工时（自由工时制不能为空） */
            workHours?: number;
            /** @description 班次工时对应出勤天数 */
            hoursToDay: number;
            ...
            absentLateMinutes?: number;
            /** @description 半天工作时间设置 */
            halfDayWorkTimeSetting: components["schemas"]["HalfDayWorkTimeSettingEdit"];
            /** @description 班次颜色 */
            color?: string;
            /** @description 是否区分令时（0：不区分；1：区分） */
            isDivisiveSeason: boolean;
            ...
            winterMonth?: number[];
            /** @description 弹性打卡设置 */
            flexibleClockSetting: components["schemas"]["FlexibleClockSettingEdit"];
        };
        ...
        ShiftTimePeriodROModify: {
            ...
            clockOutEndTime?: string;
            /** @description 休息时段 */
            breakTimePeriods?: components["schemas"]["BreakTimePeriodROModify"][];
        };
        ShiftTimePeriodSeasonModify: {
            /** @description 令时（0：不区分令时；1：夏令时；2：冬令时） */
            season?: number;
            /** @description 令时对应时段配置 */
            timePeriods?: components["schemas"]["ShiftTimePeriodROModify"][];
        };
        HalfDayWorkTimeSettingModify: {
            /** @description 上午时段 */
            am?: components["schemas"]["TimePeriodModify"];
            /** @description 下午时段 */
            pm?: components["schemas"]["TimePeriodModify"];
        };
        ...
        FlexibleClockSettingModify: {
            ...
            flexibleMode: number;
            /** @description 弹性打卡模式 - 弹性时间设置 */
            flexibleTimeSetting?: components["schemas"]["FlexibleTimeSettingModify"];
            /** @description 是否开启下班晚走，次日晚到 */
            leaveLateArriveLateEnabled?: boolean;
            /** @description 下班晚走次日晚到时间设置 */
            leaveLateArriveLateTimeSetting?: components["schemas"]["FlexibleTimeSettingModify"][];
            /** @description 作用方式（1：作用于整个班次；2：作用于每个时段） */
            modeOfAction?: number;
        };
        ShiftSaveROModify: {
            ...
            name: string;
            /** @description 班次时段令时配置 */
            timePeriodSeasons: components["schemas"]["ShiftTimePeriodSeasonModify"][];
            /** @description 班次工时（自由工时制不能为空） */
            workHours?: number;
            /** @description 班次工时对应出勤天数 */
            hoursToDay: number;
            ...
            absentLateMinutes?: number;
            /** @description 半天工作时间设置 */
            halfDayWorkTimeSetting: components["schemas"]["HalfDayWorkTimeSettingModify"];
            /** @description 班次颜色 */
            color?: string;
            /** @description 是否区分令时 */
            isDivisiveSeason: boolean;
            ...
            winterMonth?: number[];
            /** @description 弹性打卡设置 */
            flexibleClockSetting: components["schemas"]["FlexibleClockSettingModify"];
        };
        GroupBaseInfo: {
            /** Format: int64 */
            id?: number;
        ...
        ServiceResultListGroupBaseInfo: {
            ...
            success?: boolean;
            /** @description 主数据 */
            data?: components["schemas"]["GroupBaseInfo"][];
            /** @description 业务状态消息 */
            message?: string;
            /** @description trace id */
            tid?: string;
        ...
        ShiftCycleVO: {
            ...
            name?: string;
            daysNum?: number;
            cycle?: components["schemas"]["ShiftSummaryInfoVO"][];
        };
        ServiceResultListShiftCycleVO: {
            code?: string;
            success?: boolean;
            data?: components["schemas"]["ShiftCycleVO"][];
            message?: string;
            tid?: string;
        };
        ...
        ScheduleCalendar: {
            ...
            isDayOff?: boolean;
            /** @description 排班班次 */
            scheduleShift?: components["schemas"]["ShiftBaseInfoVO"];
            /** @description 调班信息 */
            changeShiftInfo?: components["schemas"]["StaffShiftScheduleInfo"];
        };
        StaffShiftScheduleVO: {
            ...
            staffName?: string;
            /** @description 日历与排班信息 */
            scheduleCalendars?: components["schemas"]["ScheduleCalendar"][];
        };
        PageStaffShiftScheduleVO: {
            records?: components["schemas"]["StaffShiftScheduleVO"][];
            /** Format: int64 */
            total?: number;
            /** Format: int64 */
            size?: number;
        ...
        ServiceResultPageStaffShiftScheduleVO: {
            code?: string;
            success?: boolean;
            data?: components["schemas"]["PageStaffShiftScheduleVO"];
            message?: string;
            tid?: string;
        };
        ...
        ShiftScheduleResultVO: {
            ...
            failedList?: components["schemas"]["ShiftScheduleFailedMessage"][];
            /** @description 员工排班数据 */
            staffSchedules?: components["schemas"]["StaffShiftScheduleVO"][];
        };
        ServiceResultShiftScheduleResultVO: {
            code?: string;
            success?: boolean;
            data?: components["schemas"]["ShiftScheduleResultVO"];
            message?: string;
            tid?: string;
        };
        ...
        ManualScheduleROEdit: {
            ...
            id?: number;
            currentUser?: components["schemas"]["LoginCacheEdit"];
            scheduleData: components["schemas"]["StaffScheduleDataEdit"][];
            /** Format: int64 */
            shiftId: number;
        };
        ...
        CustomScheduleROEdit: {
            ...
            date: string;
            /** @description 排班时段 */
            periods: components["schemas"]["TimePeriodEdit"][];
        };
        ...
        GroupCalendarVO: {
            ...
            year?: number;
            /** @description 考勤月日历列表 */
            monthCalendarList?: components["schemas"]["MonthCalendar"][];
        };
        ServiceResultGroupCalendarVO: {
            ...
            success?: boolean;
            /** @description 主数据 */
            data?: components["schemas"]["GroupCalendarVO"];
            /** @description 业务状态消息 */
            message?: string;
            /** @description trace id */
            tid?: string;
        ...
        BngMenu: {
            ...
            isApp?: number;
            isChecked?: number;
            children?: components["schemas"]["BngMenu"][];
            powerList?: components["schemas"]["BngPower"][];
            /** @description 应用名称 */
            appNames?: string[];
        };
        UserRoleMenusDTO: {
            bngRoles?: components["schemas"]["BngRole"][];
            bngPowers?: components["schemas"]["BngPower"][];
            bngMenus?: components["schemas"]["BngMenu"][];
        };
        RoleDateRangeVO: {
        ...
        ServiceResultUserRoleMenusDTO: {
            code?: string;
            success?: boolean;
            data?: components["schemas"]["UserRoleMenusDTO"];
            message?: string;
            tid?: string;
        };
        RoleDeptStaffVO: {
            ...
            /** @description 时间戳 */
            ts?: string;
            dateRangeList?: components["schemas"]["RoleDateRangeVO"][];
        };
        ServiceResultListRoleDeptStaffVO: {
            ...
            errorCode?: number;
            message?: string;
            data?: components["schemas"]["RoleDeptStaffVO"][];
        };
        ExchangeCompanyDTO: {
            /** @description 手机号 */
            mobile?: string;
        ...
        BngRoleDTO: {
            ...
            ts?: string;
            /** @description 数据权限入参 */
            roleDeptStaffList?: components["schemas"]["RoleDeptStaffDTO"][];
        };
        RoleDeptStaffDTO: {
            /**
             * Format: int64
        ...
        OrgDeptTree: {
            /** @description 唯一标识  dept+autoNo */
            unionKey?: string;
            childrenDept?: components["schemas"]["OrgDeptTree"][];
            staffList?: components["schemas"]["OrgDeptStaff"][];
            /**
             * Format: int64
             ...
             */
            type: number;
            leader?: components["schemas"]["OrgDeptStaff"];
            staffNums?: number;
            /** @description 部门所有成员 包括子部门的成员 */
            sumStaffNums?: number;
        };
        ...
        OrgDeptTreeVO: {
            deptTrees?: components["schemas"]["OrgDeptTree"][];
        };
        ServiceResultListRoleStaffVO: {
            code?: string;
            success?: boolean;
            data?: components["schemas"]["RoleStaffVO"][];
            message?: string;
            tid?: string;
        };
        ServiceResultOrgDeptTreeVO: {
            code?: string;
            success?: boolean;
            data?: components["schemas"]["OrgDeptTreeVO"];
            message?: string;
            tid?: string;
        };
        ...
        OrgEnterpriseCostCenterVO: {
            ...
            /** @description 员工数 */
            staffNums?: number;
            staffBaseInfoList?: components["schemas"]["SimpleStaffInfoVO"][];
        };
        PageOrgEnterpriseCostCenterVO: {
            records?: components["schemas"]["OrgEnterpriseCostCenterVO"][];
            /** Format: int64 */
            total?: number;
            /** Format: int64 */
            size?: number;
        ...
        ServiceResultPageOrgEnterpriseCostCenterVO: {
            code?: string;
            success?: boolean;
            data?: components["schemas"]["PageOrgEnterpriseCostCenterVO"];
            message?: string;
            tid?: string;
        };
    };
